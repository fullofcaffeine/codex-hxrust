...
- Cafex has five unsupported seam-ledger rows;
...
| Cafetera contract subset | 6 covered, 6 passed, 0 failed, 5 gaps |
| Cafex seam ledger | 15 rows, 9 supported, 5 unsupported, 1 review-only |
