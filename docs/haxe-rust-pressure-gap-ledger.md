...
| Metric | Count |
| --- | ---: |
| Total pressure gaps | 23 |
| Resolved upstream | 15 |
| Open upstream | 8 |
| Local workaround | 0 |
| High severity | 7 |
| Medium severity | 16 |
...
| Runtime/model/session | 12 | Try/catch tail returns, interface null behavior, interface-returned null trait-object defaults, nullable class-array reads, non-copy field assign-op, non-copy local reuse, static final path lowering, Reflect.compare lowering, optional primitive default lowering, generic helper bound propagation, and optional anonymous-field reads surfaced in runtime/TUI/model-catalog/planning/request-envelope/stream-route/stream-item-reducer/async-contract work. |
...
- Nullable interface values and interface-returned null trait-object defaults now have generic upstream fixes and passing snapshots.
