...
| Haxe source/test files scanned | 368 |
...
| Runtime/model/session | 8 | Try/catch tail returns, interface null behavior, nullable class-array reads, non-copy field assign-op, non-copy local reuse, static final path lowering, and Reflect.compare lowering surfaced in runtime/TUI/model-catalog work. |
