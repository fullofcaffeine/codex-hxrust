...
`TUI-LIVE-81` through `TUI-LIVE-86` move deterministic app-server scheduler triggers
...
submitted turn active and the completion line unread, without real async socket
