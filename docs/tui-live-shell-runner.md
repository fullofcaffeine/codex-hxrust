...
`TUI-LIVE-121` proves source-fed readiness can preserve an assistant prefix
before surfacing malformed-JSON rejection evidence.
`TUI-LIVE-122` proves source-fed readiness can preserve an assistant prefix
before surfacing unsupported-notification rejection evidence.
`TUI-LIVE-123` proves source-fed readiness can preserve an assistant prefix
