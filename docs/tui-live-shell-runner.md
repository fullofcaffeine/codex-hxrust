...
`TUI-LIVE-81` through `TUI-LIVE-87` move deterministic app-server scheduler triggers
...
counts unchanged, without real async socket readiness, provider streaming,
model calls, tools, or persistence.
