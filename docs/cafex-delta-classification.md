...
3. Headless adapter behavior for active-lane, session receipt, turn receipt, effort apply, mode apply, goal apply, pending-input snapshot, and live-status refresh state transitions.
