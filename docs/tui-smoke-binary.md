...
- `TuiSmokeEventLoop` models a minimal raw Codex app-loop subset: draw, resize, resize draw scheduling, status update, input update, key dispatch, and explicit app exit.
