...
- `caf-mode-plan-request.v1.json` and `caf-mode-plan-receipt.v1.json` cover a supported plan-mode next-turn receipt with plan-checkpoint boundary metadata.
- `caf-mode-default-request.v1.json` and `caf-mode-default-receipt.v1.json` cover a supported default-mode next-turn receipt.
- `caf-mode-unsupported-request.v1.json` and `caf-mode-unsupported-receipt.v1.json` cover invalid mode refusal.
