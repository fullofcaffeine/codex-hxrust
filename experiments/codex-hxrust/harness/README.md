...
- `check-haxe-rust-upstream-repros.sh` validates the HXCX-7.2 upstream repro map and runs the remaining generic haxe.rust expected-failure fixture for `haxe.io.Path.directory`.
