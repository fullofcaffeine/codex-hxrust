...
- `check-mock-model-stream.sh` validates the credential-free upstream-shaped mock SSE stream parser, deterministic malformed-stream errors, and golden internal runtime event output.
