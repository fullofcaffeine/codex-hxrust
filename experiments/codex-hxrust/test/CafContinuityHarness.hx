...
class CafContinuityHarness {
    ...
    static function parsesResumeMetadata():Void {
        final parsed = expectMetadata(CafContinuityEnv.parse(
            "generated/cafex-continuity/resume/session.json",
            "generated/cafex-continuity/resume/turn.json",
            " codex-restart-successor-1 ",
    ...
    static function parsesFreshMetadata():Void {
        final parsed = expectMetadata(CafContinuityEnv.parse(
            "generated/cafex-continuity/fresh/session.json",
            "generated/cafex-continuity/fresh/turn.json",
    ...
    static function writesReceiptsFromParsedMetadata():Void {
        ...
        final resume = expectMetadata(CafContinuityEnv.parse(resumeDir + "/session.json", resumeDir + "/turn.json", "codex-restart-successor-1", "session-predecessor-1"));
        final sessionWrite = CafReceiptWriter.maybeWriteSessionReceipt(resume.toReceiptEnv(), "session-resumed-continuity", resume.receiptSource, "2026-06-10T00:00:04Z");
        ...
        final turnWrite = CafReceiptWriter.maybeWriteTurnReceipt(fresh.toReceiptEnv(), "session-fresh-continuity", "turn-continuity-1", fresh.receiptSource, "2026-06-10T00:00:05Z");
