...
class CafActiveLaneHarness {
    ...
    static function rejectsMismatchedPid():Void {
        ...
        final path = baseDir + "/active-lane.json";
        resetDir(baseDir);
        final outcome = CafActiveLaneWriter.maybeWriteActiveLane(envFor(path, "4243", "codex-active-lane-test", ""), "conversation-active-lane-test", null, nativePid, writtenAt);
    ...
    static function rejectsMismatchedRunIds():Void {
        ...
        final path = baseDir + "/active-lane.json";
        resetDir(baseDir);
        final outcome = CafActiveLaneWriter.maybeWriteActiveLane(envFor(path, "4242", "run-a", "run-b"), "conversation-active-lane-test", null, nativePid, writtenAt);
    ...
    static function envFor(path:String, ownerPid:String, runId:String, successorRunId:String):CafActiveLaneEnv {
        return new CafActiveLaneEnv(
            ...
            successorRunId,
            ownerPid,
            "generation-active-lane-test",
            ".cafetera/client/wakes/codex/codex-active-lane-test/requests",
            ".cafetera/client/wakes/codex/codex-active-lane-test/receipts",
