...
| `mock-model-stream.hxml` | Compile the HXCX-3.1/HXCX-3.3 mock model stream parser, fixture provider, and one-turn state-machine harness through portable haxe.rust. |
