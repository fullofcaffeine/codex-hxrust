...
class SandboxGateDecision {
    ...
    public function new(ok:Bool, allowed:Bool, enforced:Bool, platform:String, sandboxMode:String, operation:String, path:String, errorCode:String, errorMessage:String) {
        this.ok = ok;
