import codexhx.validation.tui.resume.live.PostRenderCompletionHandoffGate;
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayCompletionHandoffRenderHarness {
	static function main():Void {
		...
		assertContains(report.summary(), "renderedSnapshotPreserved=true;finalSelectionPreserved=true;finalFooterPreserved=true");
		...
		assertNotContains(report.summary(), "post_completion_post_render_replay_completion_rejected");
