...
import codexhx.validation.tui.resume.live.recovery.ninth.CompletionHandoffGate;

class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateNinthCycleReplayCompletionHandoffRenderHarness {
	static function main():Void {
		final report = CompletionHandoffGate.run();
		...
		assertContains(summary, "reason=post_completion_post_render_replay_aware_rendered_state_ninth_cycle_replay_completed_for_next_slice");
		...
		assertNotContains(summary, "post_completion_post_render_replay_aware_rendered_state_ninth_cycle_replay_completion_rejected");
