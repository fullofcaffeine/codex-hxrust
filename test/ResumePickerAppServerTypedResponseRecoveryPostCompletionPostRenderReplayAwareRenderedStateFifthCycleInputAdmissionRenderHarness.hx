import codexhx.validation.tui.resume.live.FifthInputAdmissionGate;
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFifthCycleInputAdmissionRenderHarness {
	static function main():Void {
		...
		assertContains(report.summary(),
			"noModelCall=true;noFilesystemMutation=true;reason=post_completion_post_render_replay_aware_rendered_state_fifth_cycle_input_admitted_after_replay");
		...
		assertNotContains(report.summary(), "post_completion_post_render_replay_aware_rendered_state_fifth_cycle_input_rejected_before_replay");
