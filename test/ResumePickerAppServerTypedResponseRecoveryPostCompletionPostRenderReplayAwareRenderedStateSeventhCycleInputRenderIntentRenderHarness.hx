import codexhx.runtime.tui.resume.live.ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleInputRenderIntentRenderGate;

class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleInputRenderIntentRenderHarness {
	static function main():Void {
		final report = ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleInputRenderIntentRenderGate.run();
		...
		assertUnder(23500, summary.length, "summary length");
		...
		assertContains(summary, "finalSelectionPreserved=true;finalFooterPreserved=true;inputAdmitted=true;completionReady=true;nextSliceReady=true");
		...
		assertContains(summary, "kind=local_render_requested;sourceIntent=confirm_recovered_selection;renderRequested=true;renderSequence=1");
		assertContains(summary,
			"noModelCall=true;noFilesystemMutation=true;reason=post_completion_post_render_replay_aware_rendered_state_seventh_cycle_input_local_render_intent_requested");
		assertContains(summary, "admissionKind=input_admitted;inputAdmitted=true");
		assertContains(summary, "reason=post_completion_post_render_replay_aware_rendered_state_seventh_cycle_input_admitted_after_replay");
		assertNotContains(summary, "post_completion_post_render_replay_aware_rendered_state_seventh_cycle_input_render_intent_rejected");
