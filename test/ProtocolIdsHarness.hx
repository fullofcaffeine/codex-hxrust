...
class ProtocolIdsHarness {
	...
	static function expectSession(value:Null<SessionId>):SessionId
		return value == null ?throw "expected SessionId":value;

	static function expectThread(value:Null<ThreadId>):ThreadId
		return value == null ?throw "expected ThreadId":value;

	static function expectTurn(value:Null<TurnId>):TurnId
		return value == null ?throw "expected TurnId":value;

	static function expectToolCall(value:Null<ToolCallId>):ToolCallId
		return value == null ?throw "expected ToolCallId":value;

	static function expectModel(value:Null<ModelId>):ModelId
		return value == null ?throw "expected ModelId":value;

	static function expectPath(value:Null<PathLikeId>):PathLikeId
		return value == null ?throw "expected PathLikeId":value;

	static function expectRequest(value:Null<RequestId>):RequestId
		return value == null ?throw "expected RequestId":value;

	static function assertNullSession(value:Null<SessionId>):Void
		if (value != null)
			throw "expected null SessionId";

	static function assertNullThread(value:Null<ThreadId>):Void
		if (value != null)
			throw "expected null ThreadId";

	static function assertNullTurn(value:Null<TurnId>):Void
		if (value != null)
			throw "expected null TurnId";

	static function assertNullToolCall(value:Null<ToolCallId>):Void
		if (value != null)
			throw "expected null ToolCallId";

	static function assertNullModel(value:Null<ModelId>):Void
		if (value != null)
			throw "expected null ModelId";

	static function assertNullPath(value:Null<PathLikeId>):Void
		if (value != null)
			throw "expected null PathLikeId";
