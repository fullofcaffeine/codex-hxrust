import codexhx.validation.tui.resume.live.EighthInputRenderIntentGate;
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateEighthCycleInputRenderIntentRenderHarness {
	static function main():Void {
		...
		assertContains(summary,
			"noModelCall=true;noFilesystemMutation=true;reason=post_completion_post_render_replay_aware_rendered_state_eighth_cycle_input_local_render_intent_requested");
		assertContains(summary, "admissionKind=input_admitted;inputAdmitted=true");
		assertContains(summary, "reason=post_completion_post_render_replay_aware_rendered_state_eighth_cycle_input_admitted_after_replay");
		assertNotContains(summary, "post_completion_post_render_replay_aware_rendered_state_eighth_cycle_input_render_intent_rejected");
