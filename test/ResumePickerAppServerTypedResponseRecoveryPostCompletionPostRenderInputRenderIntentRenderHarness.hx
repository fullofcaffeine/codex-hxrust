...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderInputRenderIntentRenderHarness {
	static function main():Void {
		...
		assertContains(report.summary(), "localOnlyRenderIntent=true");
		assertContains(report.summary(), "noModelCall=true;noFilesystemMutation=true;reason=post_completion_post_render_input_local_render_intent_requested");
		assertContains(report.summary(), "admissionKind=input_admitted;inputAdmitted=true");
		assertContains(report.summary(), "reason=post_completion_post_render_input_admitted_after_replay");
		assertNotContains(report.summary(), "post_completion_post_render_input_render_intent_rejected");
