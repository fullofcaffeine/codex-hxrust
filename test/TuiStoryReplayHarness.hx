...
class TuiStoryReplayHarness {
    ...
    static function parsesSelectedOssStory():Void {
        ...
        assertContains(summary.fingerprint(), "codex=15:session_configured,task_started,agent_reasoning_raw_content_delta,agent_message_delta,task_complete,shutdown_complete");
    ...
    static function rejectsInvalidRecords():Void {
        final invalidKind = TuiStoryReplayParser.parseLine("{\"ts\":\"2025-08-10T03:12:26.500Z\",\"dir\":\"to_tui\",\"kind\":\"log_line\",\"line\":\"ignored\"}", 1);
