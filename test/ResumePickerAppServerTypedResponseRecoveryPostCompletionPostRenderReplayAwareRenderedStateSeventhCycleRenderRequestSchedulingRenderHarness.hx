import codexhx.runtime.tui.resume.live.ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleRenderRequestSchedulingRenderGate;

class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleRenderRequestSchedulingRenderHarness {
	static function main():Void {
		final report = ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleRenderRequestSchedulingRenderGate.run();
		...
		assertEquals("typed_response_recovery_post_completion_post_render_replay_aware_rendered_state_seventh_cycle_local_render:thread-surface-a",
		...
		assertUnder(29000, summary.length, "summary length");
		assertContains(summary, "scheduleKind=local_render_scheduled;scheduleRequested=true;scheduled=true;scheduleSequence=1;schedulerRequestCount=1");
		assertContains(summary,
			"schedulerSummary=typed_response_recovery_post_completion_post_render_replay_aware_rendered_state_seventh_cycle_local_render:thread-surface-a");
		...
		assertContains(summary, "kind=local_render_scheduled;sourceRenderIntentKind=local_render_requested");
		assertContains(summary, "schedulerPendingCount=1;schedulerSkippedCount=0");
		...
		assertContains(summary,
			"noModelCall=true;noFilesystemMutation=true;reason=post_completion_post_render_replay_aware_rendered_state_seventh_cycle_local_render_request_scheduled");
		assertContains(summary, "renderIntentKind=local_render_requested;renderRequested=true;localOnlyRenderIntent=true");
		assertContains(summary, "reason=post_completion_post_render_replay_aware_rendered_state_seventh_cycle_input_local_render_intent_requested");
		assertNotContains(summary, "post_completion_post_render_replay_aware_rendered_state_seventh_cycle_local_render_request_rejected");
