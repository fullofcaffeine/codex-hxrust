import codexhx.runtime.tui.resume.live.ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderRequestSchedulingRenderGate;
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderRequestSchedulingRenderHarness {
	static function main():Void {
		final report = ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderRequestSchedulingRenderGate.run();
		...
		assertEquals("typed_response_recovery_post_completion_post_render_replay_aware_local_render:thread-surface-a", report.schedulerSummary,
			"scheduler reason");
		...
		assertContains(report.summary(),
			"noModelCall=true;noFilesystemMutation=true;reason=post_completion_post_render_replay_aware_local_render_request_scheduled");
		assertContains(report.summary(), "renderIntentKind=local_render_requested;renderRequested=true;localOnlyRenderIntent=true");
		assertContains(report.summary(), "reason=post_completion_post_render_replay_aware_input_local_render_intent_requested");
		assertNotContains(report.summary(), "post_completion_post_render_replay_aware_local_render_request_rejected");
