...
import codexhx.runtime.tui.resume.live.ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFifthCycleReplayCompletionHandoffRenderGate;

class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFifthCycleReplayCompletionHandoffRenderHarness {
	static function main():Void {
		final report = ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFifthCycleReplayCompletionHandoffRenderGate.run();
		...
		assertContains(report.summary(), "reason=post_completion_post_render_replay_aware_rendered_state_fifth_cycle_replay_completed_for_next_slice");
		assertContains(report.summary(), "reason=post_completion_post_render_replay_aware_rendered_state_fifth_cycle_keyboard_snapshot_replayed");
		assertContains(report.summary(), "noModelCall=true;noFilesystemMutation=true;nextSliceReady=true");
		assertNotContains(report.summary(), "post_completion_post_render_replay_aware_rendered_state_fifth_cycle_replay_completion_rejected");
		assertNotContains(report.summary(), "post_completion_post_render_replay_aware_rendered_state_fifth_cycle_keyboard_render_state_decision_rejected");
