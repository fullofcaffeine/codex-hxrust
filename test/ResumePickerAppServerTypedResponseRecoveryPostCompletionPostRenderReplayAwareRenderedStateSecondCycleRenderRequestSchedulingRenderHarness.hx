import codexhx.runtime.tui.resume.live.ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleRenderRequestSchedulingRenderGate;

class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleRenderRequestSchedulingRenderHarness {
	static function main():Void {
		final report = ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleRenderRequestSchedulingRenderGate.run();
		...
		assertEquals("typed_response_recovery_post_completion_post_render_replay_aware_rendered_state_second_cycle_local_render:thread-surface-a",
		...
		assertContains(report.summary(),
			"schedulerSummary=typed_response_recovery_post_completion_post_render_replay_aware_rendered_state_second_cycle_local_render:thread-surface-a");
		...
		assertContains(report.summary(),
			"noModelCall=true;noFilesystemMutation=true;reason=post_completion_post_render_replay_aware_rendered_state_second_cycle_local_render_request_scheduled");
		assertContains(report.summary(), "renderIntentKind=local_render_requested;renderRequested=true;localOnlyRenderIntent=true");
		assertContains(report.summary(), "reason=post_completion_post_render_replay_aware_rendered_state_second_cycle_input_local_render_intent_requested");
		assertNotContains(report.summary(), "post_completion_post_render_replay_aware_rendered_state_second_cycle_local_render_request_rejected");
