import codexhx.runtime.tui.resume.live.ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleScheduledExecutionHandoffRenderGate;

class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleScheduledExecutionHandoffRenderHarness {
	static function main():Void {
		final report = ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleScheduledExecutionHandoffRenderGate.run();
		...
		assertUnder(44000, summary.length, "summary length");
		assertContains(summary, "handoffKind=rendered_idle_list_ready;postRenderIdleListReady=true;keyboardInputReady=true;listNavigationReady=true");
		...
		assertContains(summary, "sourcePreExecutionConsumedRequestCount=1;sourcePreExecutionRenderCount=1");
		assertContains(summary, "sourceRenderedSnapshotPreserved=true;sourceInputAdmitted=true;sourceLocalOnlyRenderIntent=true");
		...
		assertContains(summary, "kind=rendered_idle_list_ready;sourceExecutionKind=local_render_executed");
		assertContains(summary, "noModelCall=true;noFilesystemMutation=true");
		assertContains(summary, "reason=post_completion_post_render_replay_aware_rendered_state_seventh_cycle_scheduled_execution_handed_to_idle_list");
		assertContains(summary, "executionKind=local_render_executed;executionRequested=true;rendered=true");
		assertContains(summary, "reason=post_completion_post_render_replay_aware_rendered_state_seventh_cycle_local_render_request_executed");
		assertNotContains(summary, "post_completion_post_render_replay_aware_rendered_state_seventh_cycle_scheduled_execution_handoff_rejected");
