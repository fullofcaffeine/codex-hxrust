...
class ToolRegistry {
    ...
    public function registerMcpTool(serverName:String, rawToolName:String, description:String, inputSchema:Value, connectorId:String, connectorName:String, supportsParallelToolCalls:Bool):ToolLookupOutcome {
