...
class ProcessExecOutcome {
    ...
    public function new(ok:Bool, executed:Bool, command:String, args:Array<String>, exitCode:Int, exitStatus:String, errorCode:String, errorMessage:String, stdout:ProcessOutputSlice, stderr:ProcessOutputSlice) {
        this.ok = ok;
    ...
    public static function denied(command:String, args:Array<String>):ProcessExecOutcome {
        return new ProcessExecOutcome(
            ...
            "not_executed",
            "command_denied",
            "process execution requires an exact approval",
            emptyOutput(),
            emptyOutput()
        );
    }
    ...
    public static function spawned(command:String, args:Array<String>, exitCode:Int, stdout:ProcessOutputSlice, stderr:ProcessOutputSlice):ProcessExecOutcome {
        ...
        return new ProcessExecOutcome(false, true, command, args, exitCode, "nonzero", "process_exit_nonzero", "process exited with non-zero status", stdout, stderr);
    }
