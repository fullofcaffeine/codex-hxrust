...
class ApplyPatchDryRunOutcome {
	...
	public function new(ok:Bool, mutationEnabled:Bool, wouldMutate:Bool, errorCode:String, errorPath:String, errorMessage:String,
			operations:Array<ApplyPatchOperation>) {
		this.ok = ok;
