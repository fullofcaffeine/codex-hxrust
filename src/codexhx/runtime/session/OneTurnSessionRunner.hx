...
class OneTurnSessionRunner {
	...
	static function cancelAtCheckpoint(client:ModelClient, handle:ModelStreamHandle, events:Array<ModelStreamEvent>,
			assistantText:String):OneTurnSessionOutcome {
