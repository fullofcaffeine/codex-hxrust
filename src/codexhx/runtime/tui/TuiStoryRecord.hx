...
class TuiStoryRecord {
    ...
    public function summary():String {
        return Std.string(lineNumber) + ":" + direction + ":" + kind + ":" + normalizedTime + ":" + appVariant + ":" + keySummary()
            + ":" + codexEventType + ":" + textDelta + ":" + Std.string(historyLines) + ":" + operationType + ":" + sourceId;
    }
