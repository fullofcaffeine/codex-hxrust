...
class TurnRuntimeState {
	...
	function new(status:TurnRuntimeStatus, running:Bool, assistantDraft:String, assistantFinalMarkdown:String, assistantFinalSource:TurnMessageSource,
			lastAgentMarkdown:String, sawCopySourceThisTurn:Bool, notificationResponse:String, planDraftLines:Array<String>,
			finalPlanItems:Array<TurnPlanItem>, consolidatedPlanItems:Array<TurnPlanItem>, sawPlanItemThisTurn:Bool, pendingFollowUps:Array<String>,
			pendingSteers:Array<String>, startedFollowUp:String, submitPendingSteersAfterInterrupt:Bool, hadWorkActivity:Bool, finalSeparatorNeeded:Bool,
			completionNotified:Bool, terminalReason:TurnTerminalReason, failureMessage:String) {
		this.status = status;
	...
	public static function initial():TurnRuntimeState {
		return new TurnRuntimeState(TurnRuntimeStatus.Idle, false, "", "", TurnMessageSource.None, "", false, "", [], [], [], false, [], [], "", false, false,
			false, false, TurnTerminalReason.None, "");
	}

	public function withValues(status:TurnRuntimeStatus, running:Bool, assistantDraft:String, assistantFinalMarkdown:String,
			assistantFinalSource:TurnMessageSource, lastAgentMarkdown:String, sawCopySourceThisTurn:Bool, notificationResponse:String,
			planDraftLines:Array<String>, finalPlanItems:Array<TurnPlanItem>, consolidatedPlanItems:Array<TurnPlanItem>, sawPlanItemThisTurn:Bool,
			pendingFollowUps:Array<String>, pendingSteers:Array<String>, startedFollowUp:String, submitPendingSteersAfterInterrupt:Bool, hadWorkActivity:Bool,
			finalSeparatorNeeded:Bool, completionNotified:Bool, terminalReason:TurnTerminalReason, failureMessage:String):TurnRuntimeState {
		return new TurnRuntimeState(status, running, assistantDraft, assistantFinalMarkdown, assistantFinalSource, lastAgentMarkdown, sawCopySourceThisTurn,
			notificationResponse, planDraftLines, finalPlanItems, consolidatedPlanItems, sawPlanItemThisTurn, pendingFollowUps, pendingSteers,
			startedFollowUp, submitPendingSteersAfterInterrupt, hadWorkActivity, finalSeparatorNeeded, completionNotified, terminalReason, failureMessage);
	}
