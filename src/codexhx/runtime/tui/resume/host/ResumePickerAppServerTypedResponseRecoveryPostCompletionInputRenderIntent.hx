...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionInputRenderIntentFields = {
	final kind:ResumePickerAppServerTypedResponseRecoveryPostCompletionInputRenderIntentKind;
	final sourceIntent:ResumePickerAppServerTypedResponseRecoveryPostCompletionInputIntentKind;
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionInputRenderIntent {
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryPostCompletionInputRenderIntentKind.Unknown)
	public final kind:ResumePickerAppServerTypedResponseRecoveryPostCompletionInputRenderIntentKind;
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryPostCompletionInputIntentKind.Unknown)
	public final sourceIntent:ResumePickerAppServerTypedResponseRecoveryPostCompletionInputIntentKind;
