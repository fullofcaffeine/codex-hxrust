...
typedef RefreshReplayDeliveryFields = {
	final kind:RefreshReplayDeliveryKind;
...
class RefreshReplayDelivery {
	@:recordDefault(RefreshReplayDeliveryKind.Unknown)
	public final kind:RefreshReplayDeliveryKind;
