...
typedef RecoveryKeyboardRenderStateFields = {
	final kind:RecoveryKeyboardRenderStateKind;
...
class RecoveryKeyboardRenderState {
	@:recordDefault(RecoveryKeyboardRenderStateKind.Unknown)
	public final kind:RecoveryKeyboardRenderStateKind;
