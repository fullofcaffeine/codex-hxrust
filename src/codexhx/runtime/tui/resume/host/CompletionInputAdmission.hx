...
typedef CompletionInputAdmissionFields = {
	final kind:CompletionInputAdmissionKind;
	final intent:CompletionInputIntentKind;
	final admitted:Bool;
	final sequence:Int;
...
class CompletionInputAdmission {
	@:recordDefault(CompletionInputAdmissionKind.Unknown)
	public final kind:CompletionInputAdmissionKind;
	@:recordDefault(CompletionInputIntentKind.Unknown)
	public final intent:CompletionInputIntentKind;
