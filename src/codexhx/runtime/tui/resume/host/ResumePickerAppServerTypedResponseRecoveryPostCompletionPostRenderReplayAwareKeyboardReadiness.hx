...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareKeyboardReadinessFields = {
	final kind:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardReadinessKind;
	final sourceHandoffKind:ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderedStateHandoffKind;
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareKeyboardReadiness {
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardReadinessKind.Unknown)
	public final kind:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardReadinessKind;
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderedStateHandoffKind.Unknown)
	public final sourceHandoffKind:ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderedStateHandoffKind;
	...
	public function summary():String {
		return "kind=" + kind + ";sourceHandoffKind=" + sourceHandoffKind + ";decisionCount=" + decisionCount + ";admittedCount=" + admittedCount
			...
			+ boolLabel(selectedMarkerMoved) + ";recoveredSelectionRestored=" + boolLabel(recoveredSelectionRestored)
			...
			+ ";decisions=[" + decisionSummaries.join("##") + "]" + ";sourceHandoff=[" + sourceHandoffSummary + "]" + ";reason=" + reason;
	}
