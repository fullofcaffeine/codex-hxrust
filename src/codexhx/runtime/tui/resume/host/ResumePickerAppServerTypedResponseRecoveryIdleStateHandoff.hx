...
typedef ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffFields = {
	final kind:ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffKind;
...
class ResumePickerAppServerTypedResponseRecoveryIdleStateHandoff {
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffKind.Unknown)
	public final kind:ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffKind;
