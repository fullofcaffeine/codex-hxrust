...
typedef ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmationFields = {
	final kind:ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmationKind;
...
class ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmation {
	@:recordDefault(ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmationKind.Unknown)
	public final kind:ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmationKind;
