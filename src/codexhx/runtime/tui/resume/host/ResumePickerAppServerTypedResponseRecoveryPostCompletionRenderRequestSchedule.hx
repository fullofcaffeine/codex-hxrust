...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderRequestScheduleFields = {
	final kind:ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderRequestScheduleKind;
	final sourceRenderIntentKind:ResumePickerAppServerTypedResponseRecoveryPostCompletionInputRenderIntentKind;
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderRequestSchedule {
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderRequestScheduleKind.Unknown)
	public final kind:ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderRequestScheduleKind;
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryPostCompletionInputRenderIntentKind.Unknown)
	public final sourceRenderIntentKind:ResumePickerAppServerTypedResponseRecoveryPostCompletionInputRenderIntentKind;
