...
typedef RecoveryRenderSnapshotReplayFields = {
	final kind:RecoveryRenderSnapshotReplayKind;
...
class RecoveryRenderSnapshotReplay {
	@:recordDefault(RecoveryRenderSnapshotReplayKind.Unknown)
	public final kind:RecoveryRenderSnapshotReplayKind;
