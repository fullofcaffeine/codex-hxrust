...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderRenderedStateHandoffFields = {
	final kind:ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderedStateHandoffKind;
	final sourceExecutionKind:ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecutionKind;
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderRenderedStateHandoff {
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderedStateHandoffKind.Unknown)
	public final kind:ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderedStateHandoffKind;
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecutionKind.Unknown)
	public final sourceExecutionKind:ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecutionKind;
