...
typedef RecoveryReplayCompletionHandoffFields = {
	final kind:RecoveryReplayCompletionHandoffKind;
...
class RecoveryReplayCompletionHandoff {
	@:recordDefault(RecoveryReplayCompletionHandoffKind.Unknown)
	public final kind:RecoveryReplayCompletionHandoffKind;
