...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecutionFields = {
	final kind:ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecutionKind;
	final sourceScheduleKind:ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderRequestScheduleKind;
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecution {
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecutionKind.Unknown)
	public final kind:ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecutionKind;
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderRequestScheduleKind.Unknown)
	public final sourceScheduleKind:ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderRequestScheduleKind;
