...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateNinthCycleKeyboardReadinessPolicy {
	...
	public function admit(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateEighthCycleScheduledExecutionHandoffRenderGateReport,
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareKeyboardReadiness({
			...
			reason: accepted ? "post_completion_post_render_replay_aware_rendered_state_ninth_cycle_keyboard_ready" : "post_completion_post_render_replay_aware_rendered_state_ninth_cycle_keyboard_rejected"
		});
		log.push("postRenderReplayAwareRenderedStateNinthCycleKeyboard:" + compactSummary(out));
		return out;
	}
	...
	function sourceReady(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateEighthCycleScheduledExecutionHandoffRenderGateReport):Bool {
	...
	function decide(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateEighthCycleScheduledExecutionHandoffRenderGateReport,
		...
		final decision = new ResumePickerAppServerTypedResponseRecoveryKeyboardDecision({
			...
			stateDbUntouched: report.stateDbUntouched,
			reason: ready ? "post_completion_post_render_replay_aware_rendered_state_ninth_cycle_keyboard_navigation_ready" : "navigation_rejected"
		});
