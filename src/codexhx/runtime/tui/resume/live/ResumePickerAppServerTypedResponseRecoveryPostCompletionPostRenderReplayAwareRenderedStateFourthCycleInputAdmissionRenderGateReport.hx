...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleInputAdmissionRenderGateReportFields = {
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleInputAdmissionRenderGateReport {
	...
	public function summary():String {
		return "admissionKind=" + admissionKind + ";inputAdmitted=" + boolLabel(inputAdmitted) + ";sourceReadinessDecisionCount="
			...
			+ boolLabel(finalSelectionPreserved) + ";finalFooterPreserved=" + boolLabel(finalFooterPreserved) + ";completionReady="
			...
			+ boolLabel(sourceThirdCycleHandoffLocalOnlyRenderIntent) + ";sourceFourthCycleHandoffInputAdmitted="
			+ boolLabel(sourceFourthCycleHandoffInputAdmitted) + ";sourceFourthCycleHandoffLocalOnlyRenderIntent="
			+ boolLabel(sourceFourthCycleHandoffLocalOnlyRenderIntent) + ";stalePromptActionInactive=" + boolLabel(stalePromptActionInactive)
			...
			+ boolLabel(noModelCall) + ";noFilesystemMutation=" + boolLabel(noFilesystemMutation) + ";admission=[" + admissionSummary + "]"
			+ ";finalSnapshot=" + finalSnapshot.split("\n").join("\\n") + ";admissionLog=[" + admissionLogSummaries.join("##") + "]" + ";completion=["
			+ completionSummary + "]";
	}
