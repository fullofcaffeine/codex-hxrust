...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFifthCycleKeyboardReadinessPolicy {
	...
	public function admit(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleScheduledExecutionHandoffRenderGateReport,
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareKeyboardReadiness({
			...
			reason: accepted ? "post_completion_post_render_replay_aware_rendered_state_fifth_cycle_keyboard_ready" : "post_completion_post_render_replay_aware_rendered_state_fifth_cycle_keyboard_rejected"
		});
		log.push("postRenderReplayAwareRenderedStateFifthCycleKeyboard:" + out.summary());
		return out;
	}
	...
	function sourceReady(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleScheduledExecutionHandoffRenderGateReport):Bool {
	...
	function decide(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleScheduledExecutionHandoffRenderGateReport,
		...
		final decision = new ResumePickerAppServerTypedResponseRecoveryKeyboardDecision({
			...
			stateDbUntouched: report.stateDbUntouched,
			reason: ready ? "post_completion_post_render_replay_aware_rendered_state_fifth_cycle_keyboard_navigation_ready" : "navigation_rejected"
		});
