...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderedStateHandoffRenderGateReportFields = {
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderedStateHandoffRenderGateReport {
	...
	public function summary():String {
		return "handoffKind=" + handoffKind + ";postRenderIdleListReady=" + boolLabel(postRenderIdleListReady) + ";keyboardInputReady="
			...
			+ ";finalThread=" + finalThreadId + ";finalSelectionPreserved=" + boolLabel(finalSelectionPreserved) + ";finalFooterPreserved="
			...
			+ ";handoffLog=[" + handoffLogSummaries.join("##") + "]" + ";execution=[" + executionSummary + "]";
	}
