...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleScheduledExecutionHandoffRenderGateReportFields = {
	final handoffKind:ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderedStateHandoffKind;
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleScheduledExecutionHandoffRenderGateReport {
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderedStateHandoffKind.Unknown)
	public final handoffKind:ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderedStateHandoffKind;
	...
	public function summary():String {
		return "handoffKind=" + handoffKind + ";postRenderIdleListReady=" + boolLabel(postRenderIdleListReady) + ";keyboardInputReady="
			+ boolLabel(keyboardInputReady) + ";listNavigationReady=" + boolLabel(listNavigationReady) + ";noLeftoverScheduledRenderRequest="
			...
			+ consumedScheduledRequestCount + ";renderCount=" + renderCount + ";renderedSnapshotPreserved=" + boolLabel(renderedSnapshotPreserved)
			...
			+ boolLabel(localOnlyRenderIntent) + ";completionReady=" + boolLabel(completionReady) + ";nextSliceReady=" + boolLabel(nextSliceReady)
			+ ";replayCount=" + replayCount + ";sourceReplayCount=" + sourceReplayCount + ";sourceHandoffReplayCount=" + sourceHandoffReplayCount
			+ ";sourceHandoffReadinessDecisionCount=" + sourceHandoffReadinessDecisionCount + ";sourceHandoffRenderStateCount="
			...
			+ boolLabel(recoveredSelectionRestored) + ";sourcePreExecutionSchedulerRequestCount=" + sourcePreExecutionSchedulerRequestCount
			+ ";sourcePreExecutionConsumedRequestCount=" + sourcePreExecutionConsumedRequestCount + ";sourcePreExecutionRenderCount="
			+ sourcePreExecutionRenderCount + ";sourceRenderedSnapshotPreserved=" + boolLabel(sourceRenderedSnapshotPreserved) + ";sourceInputAdmitted="
			+ boolLabel(sourceInputAdmitted) + ";sourceLocalOnlyRenderIntent=" + boolLabel(sourceLocalOnlyRenderIntent) + ";sourceHandoffInputAdmitted="
			...
			+ ";finalSnapshot=" + finalSnapshot.split("\n").join("\\n") + ";handoff=[" + handoffSummary + "]" + ";handoffLog=["
			+ handoffLogSummaries.join("##") + "]" + ";execution=[" + executionSummary + "]";
	}
