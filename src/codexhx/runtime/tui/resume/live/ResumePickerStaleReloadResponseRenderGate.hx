...
class ResumePickerStaleReloadResponseRenderGate {
	public static function run():ResumePickerStaleReloadResponseRenderGateReport {
		...
		return new ResumePickerStaleReloadResponseRenderGateReport({
