...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSixthCycleRenderRequestScheduler {
	...
	public function schedule(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSixthCycleInputRenderIntentRenderGateReport,
		...
		final schedulerReason = ready ? "typed_response_recovery_post_completion_post_render_replay_aware_rendered_state_sixth_cycle_local_render:thread-surface-a" : "";
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderRequestSchedule({
			...
			reason: scheduled ? "post_completion_post_render_replay_aware_rendered_state_sixth_cycle_local_render_request_scheduled" : "post_completion_post_render_replay_aware_rendered_state_sixth_cycle_local_render_request_rejected"
		});
		nextSequence = nextSequence + 1;
		log.push("postRenderReplayAwareRenderedStateSixthCycleRequestSchedule:" + out.summary());
		return out;
	}
