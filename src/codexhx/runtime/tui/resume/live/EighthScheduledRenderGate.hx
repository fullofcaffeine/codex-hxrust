...
class EighthScheduledRenderGate {
	public static function run():EighthScheduledRenderReport {
		final schedulingReport = EighthRenderRequestGate.run();
		final renderer = new DeterministicTerminalRenderer();
		final executor = new EighthScheduledRenderExecutor();
		final execution = executor.execute(schedulingReport, renderer);
		return new EighthScheduledRenderReport({
