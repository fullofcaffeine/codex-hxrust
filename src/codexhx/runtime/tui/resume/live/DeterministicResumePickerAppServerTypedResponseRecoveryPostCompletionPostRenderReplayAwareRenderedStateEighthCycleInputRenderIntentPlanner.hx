...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateEighthCycleInputRenderIntentPlanner {
	...
	public function plan(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateEighthCycleInputAdmissionRenderGateReport):ResumePickerAppServerTypedResponseRecoveryPostCompletionInputRenderIntent {
