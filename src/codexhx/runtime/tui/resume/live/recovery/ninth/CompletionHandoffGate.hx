...
class CompletionHandoffGate {
	public static function run():CompletionHandoffReport {
		final replayReport = SnapshotReplayGate.run();
		final policy = new CompletionHandoffPolicy();
		final handoff = policy.handoff(replayReport);
		return new CompletionHandoffReport({
