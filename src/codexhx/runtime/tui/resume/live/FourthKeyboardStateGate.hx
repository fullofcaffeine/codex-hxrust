...
class FourthKeyboardStateGate {
	static final FinalFooter = "footer keyboard move_up selected=0 selectedThread=thread-surface-a";

	public static function run():FourthKeyboardStateReport {
		final readinessReport = FourthKeyboardReadinessGate.run();
		...
		return new FourthKeyboardStateReport({
	...
	static function decisionsFrom(readinessReport:FourthKeyboardReadinessReport):Array<RecoveryKeyboardDecision> {
	...
	static function decision(ready:Bool, intent:RecoveryKeyboardIntentKind, sequence:Int, selectedBefore:Int, selectedAfter:Int, threadBefore:String,
			threadAfter:String, rejectedThreadAfter:String, readinessReport:FourthKeyboardReadinessReport):RecoveryKeyboardDecision {
