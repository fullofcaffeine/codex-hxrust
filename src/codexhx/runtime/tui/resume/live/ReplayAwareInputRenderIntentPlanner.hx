...
class ReplayAwareInputRenderIntentPlanner {
	...
	public function plan(report:ReplayAwareInputAdmissionReport):CompletionInputRenderIntent {
		...
		final out = new CompletionInputRenderIntent({
			...
			reason: ready ? "post_completion_post_render_replay_aware_input_local_render_intent_requested" : "post_completion_post_render_replay_aware_input_render_intent_rejected"
		});
		nextSequence = nextSequence + 1;
		log.push("postRenderReplayAwareIntent:" + out.summary());
		return out;
	}
