...
class JsonRpcThreadReadTransportGate {
	public static function run():JsonRpcThreadReadTransportReport {
		...
		return new JsonRpcThreadReadTransportReport({
	...
	static function loadPreview(loader:DeterministicBackgroundLoader, request:ResumePickerThreadReadRequest):ResumePickerHostEvent {
