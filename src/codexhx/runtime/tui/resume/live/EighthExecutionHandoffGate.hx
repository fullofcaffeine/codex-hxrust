...
class EighthExecutionHandoffGate {
	public static function run():EighthExecutionHandoffReport {
		final executionReport = EighthScheduledRenderGate.run();
		final policy = new EighthExecutionHandoffPolicy();
		final handoff = policy.handoff(executionReport);
		return new EighthExecutionHandoffReport({
