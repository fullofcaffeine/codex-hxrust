...
class ThirdInputRenderIntentGate {
	public static function run():ThirdInputRenderIntentReport {
		final admissionReport = ThirdInputAdmissionGate.run();
		final planner = new ThirdInputRenderIntentPlanner();
		final intent = planner.plan(admissionReport);
		return new ThirdInputRenderIntentReport({
