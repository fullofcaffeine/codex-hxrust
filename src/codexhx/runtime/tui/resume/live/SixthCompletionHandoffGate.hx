...
class SixthCompletionHandoffGate {
	public static function run():SixthCompletionHandoffReport {
		final replayReport = SixthSnapshotReplayGate.run();
		final policy = new SixthCompletionHandoffPolicy();
		final handoff = policy.handoff(replayReport);
		return new SixthCompletionHandoffReport({
