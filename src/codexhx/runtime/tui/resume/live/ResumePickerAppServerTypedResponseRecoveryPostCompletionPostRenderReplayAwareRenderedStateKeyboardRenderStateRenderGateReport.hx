...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateKeyboardRenderStateRenderGateReportFields = {
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateKeyboardRenderStateRenderGateReport {
	...
	public function summary():String {
		return "readinessDecisionCount=" + readinessDecisionCount + ";readinessAdmittedCount=" + readinessAdmittedCount + ";renderStateCount="
			...
			+ ";localOnlyRenderIntent=" + boolLabel(localOnlyRenderIntent) + ";replayCount=" + replayCount + ";sourceReplayCount=" + sourceReplayCount
