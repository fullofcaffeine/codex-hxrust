...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSixthCycleReplayCompletionHandoffPolicy {
	...
	public function handoff(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSixthCycleKeyboardRenderSnapshotReplayRenderGateReport):ResumePickerAppServerTypedResponseRecoveryReplayCompletionHandoff {
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryReplayCompletionHandoff({
			...
			reason: completed ? "post_completion_post_render_replay_aware_rendered_state_sixth_cycle_replay_completed_for_next_slice" : "post_completion_post_render_replay_aware_rendered_state_sixth_cycle_replay_completion_rejected"
		});
		log.push("post-render-replay-aware-rendered-state-sixth-cycle-completion:" + out.summary());
		return out;
	}
