...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleKeyboardReadinessRenderGateReportFields = {
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleKeyboardReadinessRenderGateReport {
	...
	public function summary():String {
		return "readinessKind=" + readinessKind + ";decisionCount=" + decisionCount + ";admittedCount=" + admittedCount + ";postRenderIdleListReady="
			...
			+ ";readiness=[" + readinessSummary + "]" + ";decisions=[" + decisionSummaries.join("##") + "]" + ";policyLog=[" + policyLogSummaries.join("##")
			+ "]" + ";sourceHandoff=[" + sourceHandoffSummary + "]";
	}
