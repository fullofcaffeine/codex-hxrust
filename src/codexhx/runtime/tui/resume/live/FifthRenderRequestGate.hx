...
class FifthRenderRequestGate {
	public static function run():FifthRenderRequestReport {
		final renderIntentReport = FifthInputRenderIntentGate.run();
		final frameScheduler = new DeterministicFrameScheduler();
		final requestScheduler = new FifthRenderRequestScheduler();
		final schedule = requestScheduler.schedule(renderIntentReport, frameScheduler);
		return new FifthRenderRequestReport({
