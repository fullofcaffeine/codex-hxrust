...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleScheduledExecutionHandoffRenderGateReportFields = {
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleScheduledExecutionHandoffRenderGateReport {
	...
	public function summary():String {
		return "handoffKind=" + handoffKind + ";postRenderIdleListReady=" + boolLabel(postRenderIdleListReady) + ";keyboardInputReady="
			...
			+ sourceThirdCycleHandoffKeyboardRenderCount + ";sourceReadinessDecisionCount=" + sourceReadinessDecisionCount + ";sourceRenderStateCount="
			...
			+ boolLabel(sourceSecondCycleHandoffLocalOnlyRenderIntent) + ";sourceThirdCycleHandoffInputAdmitted="
			+ boolLabel(sourceThirdCycleHandoffInputAdmitted) + ";sourceThirdCycleHandoffLocalOnlyRenderIntent="
			...
			+ ";handoff=[" + handoffSummary + "]" + ";handoffLog=[" + handoffLogSummaries.join("##") + "]" + ";execution=[" + executionSummary + "]";
	}
