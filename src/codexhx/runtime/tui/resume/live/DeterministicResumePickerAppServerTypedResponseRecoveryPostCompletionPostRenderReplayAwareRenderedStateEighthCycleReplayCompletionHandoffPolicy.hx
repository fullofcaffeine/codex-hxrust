...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateEighthCycleReplayCompletionHandoffPolicy {
	...
	public function handoff(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateEighthCycleKeyboardRenderSnapshotReplayRenderGateReport):ResumePickerAppServerTypedResponseRecoveryReplayCompletionHandoff {
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryReplayCompletionHandoff({
			...
			reason: completed ? "post_completion_post_render_replay_aware_rendered_state_eighth_cycle_replay_completed_for_next_slice" : "post_completion_post_render_replay_aware_rendered_state_eighth_cycle_replay_completion_rejected"
		});
		log.push("post-render-replay-aware-rendered-state-eighth-cycle-completion:" + out.summary());
		return out;
	}
