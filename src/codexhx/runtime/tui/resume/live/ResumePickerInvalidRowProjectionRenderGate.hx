...
class ResumePickerInvalidRowProjectionRenderGate {
	public static function run():ResumePickerInvalidRowProjectionRenderGateReport {
		...
		return new ResumePickerInvalidRowProjectionRenderGateReport({
			pageLoads: pageLoads,
