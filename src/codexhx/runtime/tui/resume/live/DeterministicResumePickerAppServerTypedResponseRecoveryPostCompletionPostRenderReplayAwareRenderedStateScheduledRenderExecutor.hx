...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateScheduledRenderExecutor {
	...
	public function execute(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateRenderRequestSchedulingRenderGateReport,
		...
		log.push("postRenderReplayAwareRenderedStateScheduledExecution:" + execution.summary());
		return execution;
	}

	function executeReady(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateRenderRequestSchedulingRenderGateReport,
			renderer:DeterministicResumePickerTerminalRenderer):ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecution {
		...
		return new ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecution({
			...
			reason: rendered ? "post_completion_post_render_replay_aware_rendered_state_local_render_request_executed" : "post_completion_post_render_replay_aware_rendered_state_local_render_request_execution_failed"
		});
	}

	function rejected(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateRenderRequestSchedulingRenderGateReport,
			renderer:DeterministicResumePickerTerminalRenderer):ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecution {
		return new ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecution({
			...
			noFilesystemMutation: report.noFilesystemMutation,
			renderedSnapshot: "",
			reason: "post_completion_post_render_replay_aware_rendered_state_local_render_request_execution_rejected"
		});
	}
