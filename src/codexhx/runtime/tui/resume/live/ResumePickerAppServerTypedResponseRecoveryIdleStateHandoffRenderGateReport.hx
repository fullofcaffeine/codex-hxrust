...
typedef ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffRenderGateReportFields = {
	final handoffKind:ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffKind;
...
class ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffRenderGateReport {
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffKind.Unknown)
	public final handoffKind:ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffKind;
