...
class ResumePickerQueryReloadRenderGate {
	public static function run():ResumePickerQueryReloadRenderGateReport {
		...
		return new ResumePickerQueryReloadRenderGateReport({
			pageLoads: pageLoads,
