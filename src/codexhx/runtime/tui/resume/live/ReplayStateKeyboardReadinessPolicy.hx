...
class ReplayStateKeyboardReadinessPolicy {
	...
	public function admit(report:ReplayStateHandoffReport, intents:Array<RecoveryKeyboardIntentKind>):RecoveryReplayAwareKeyboardReadiness {
	...
	function sourceReady(report:ReplayStateHandoffReport):Bool {
	...
	function decide(report:ReplayStateHandoffReport, intent:RecoveryKeyboardIntentKind, ready:Bool):RecoveryKeyboardDecision {
