...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateEighthCycleScheduledExecutionHandoffPolicy {
	...
	public function handoff(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateEighthCycleScheduledRenderExecutionRenderGateReport):ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderRenderedStateHandoff {
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderRenderedStateHandoff({
			...
			reason: ready ? "post_completion_post_render_replay_aware_rendered_state_eighth_cycle_scheduled_execution_handed_to_idle_list" : "post_completion_post_render_replay_aware_rendered_state_eighth_cycle_scheduled_execution_handoff_rejected"
		});
		log.push("postRenderReplayAwareRenderedStateEighthCycleScheduledExecutionHandoff:" + out.summary());
		return out;
	}
