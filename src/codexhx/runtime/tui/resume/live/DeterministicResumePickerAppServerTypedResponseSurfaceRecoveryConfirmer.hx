...
import codexhx.runtime.tui.resume.host.ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmation;
import codexhx.runtime.tui.resume.host.ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmationKind;

class DeterministicResumePickerAppServerTypedResponseSurfaceRecoveryConfirmer {
	...
	public function confirm(report:ResumePickerAppServerTypedResponseReplaySurfaceUpdateRenderGateReport):ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmation {
		...
		final confirmation = new ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmation({
	...
	static function confirmationKind(report:ResumePickerAppServerTypedResponseReplaySurfaceUpdateRenderGateReport,
			recoveryState:String):ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmationKind {
		if (report.surfaceUpdateCount == 15
			...
			return ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmationKind.RecoveryConfirmed;
		return ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmationKind.RecoveryRejected;
	}

	static function confirmationReason(report:ResumePickerAppServerTypedResponseReplaySurfaceUpdateRenderGateReport, recoveryState:String):String {
		return confirmationKind(report,
			recoveryState) == ResumePickerAppServerTypedResponseSurfaceRecoveryConfirmationKind.RecoveryConfirmed ? "recovery_page_replaced_transient_response_surfaces" : "recovery_surface_policy_failed";
	}
