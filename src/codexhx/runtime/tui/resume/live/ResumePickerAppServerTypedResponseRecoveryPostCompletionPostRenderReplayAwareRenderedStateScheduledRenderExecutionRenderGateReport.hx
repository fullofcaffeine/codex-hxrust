...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateScheduledRenderExecutionRenderGateReportFields = {
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateScheduledRenderExecutionRenderGateReport {
	...
	public function summary():String {
		return "executionKind=" + executionKind + ";executionRequested=" + boolLabel(executionRequested) + ";rendered=" + boolLabel(rendered)
			...
			+ ";sourceHandoffKeyboardRenderCount=" + sourceHandoffKeyboardRenderCount + ";finalThread=" + finalThreadId + ";finalFooter=" + finalFooter
			+ ";finalSelectionPreserved=" + boolLabel(finalSelectionPreserved) + ";finalFooterPreserved=" + boolLabel(finalFooterPreserved)
			+ ";inputAdmitted=" + boolLabel(inputAdmitted) + ";completionReady=" + boolLabel(completionReady) + ";nextSliceReady="
			...
			+ boolLabel(noLeftoverScheduledRenderRequest) + ";sourcePreExecutionSchedulerRequestCount=" + sourcePreExecutionSchedulerRequestCount
			...
			+ ";executionLog=[" + executionLogSummaries.join("##") + "]" + ";scheduling=[" + schedulingSummary + "]";
	}
