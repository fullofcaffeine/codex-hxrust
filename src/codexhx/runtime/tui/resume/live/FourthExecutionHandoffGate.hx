...
class FourthExecutionHandoffGate {
	public static function run():FourthExecutionHandoffReport {
		final executionReport = FourthScheduledRenderGate.run();
		final policy = new FourthExecutionHandoffPolicy();
		final handoff = policy.handoff(executionReport);
		return new FourthExecutionHandoffReport({
