...
class SixthInputRenderIntentGate {
	public static function run():SixthInputRenderIntentReport {
		final admissionReport = SixthInputAdmissionGate.run();
		final planner = new SixthInputRenderIntentPlanner();
		final intent = planner.plan(admissionReport);
		return new SixthInputRenderIntentReport({
