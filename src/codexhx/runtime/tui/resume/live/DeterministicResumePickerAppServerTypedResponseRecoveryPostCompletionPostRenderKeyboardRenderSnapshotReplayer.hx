...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardRenderSnapshotReplayer {
	public function new() {}

	public function replay(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardRenderStateRenderGateReport):Array<ResumePickerAppServerTypedResponseRecoveryRenderSnapshotReplay> {
		return [
	...
	function entry(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardRenderStateRenderGateReport, replayIndex:Int,
			sourceSequence:Int, intent:ResumePickerAppServerTypedResponseRecoveryKeyboardIntentKind, selectedThreadId:String, expectedMarker:String,
		...
		return new ResumePickerAppServerTypedResponseRecoveryRenderSnapshotReplay({
			...
			snapshot: snapshot,
			reason: "post_completion_post_render_keyboard_snapshot_replayed"
		});
	}
