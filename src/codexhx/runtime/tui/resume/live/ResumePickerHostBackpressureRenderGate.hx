...
class ResumePickerHostBackpressureRenderGate {
	public static function run():ResumePickerHostBackpressureRenderGateReport {
		...
		return new ResumePickerHostBackpressureRenderGateReport({
