...
class ResumePickerAppServerServerRequestDeliveryRenderGate {
	static final SERVER_REQUEST_ID = "server-request-delivery-1";

	public static function run():ResumePickerAppServerServerRequestDeliveryRenderGateReport {
		...
		final pump = new ResumePickerAppServerEventPump(1, fanout, scheduler, 4);
		...
		final serverPoll = pump.forward(ResumePickerAppServerStreamEvent.serverRequest(1, SERVER_REQUEST_ID, requestDetail));
		...
		final intent = ResumePickerAppServerRequestResponseIntent.refused(serverDispatch.hostEvent.requestId, serverDispatch.hostEvent.detail,
		...
		final pagePoll = pump.forward(ResumePickerAppServerStreamEvent.pageResult(1, "server-request-recovery-page", threadListResultJson("delivery")));
		...
		return new ResumePickerAppServerServerRequestDeliveryRenderGateReport({
			...
			responseIntentRecorded: intent.kind == ResumePickerAppServerRequestResponseIntentKind.Refused
	...
	static function applyServerRequestDelivery(state:ResumePickerState, event:ResumePickerHostEvent, intent:ResumePickerAppServerRequestResponseIntent):Void {
