...
class PostRenderInputAdmissionPolicy {
	...
	public function admit(report:PostRenderCompletionHandoffReport, intent:CompletionInputIntentKind):CompletionInputAdmission {
