...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleKeyboardReadinessRenderGateReportFields = {
	final readinessKind:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardReadinessKind;
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleKeyboardReadinessRenderGateReport {
	@:recordDefault(ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardReadinessKind.Unknown)
	public final readinessKind:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardReadinessKind;
	...
	public function summary():String {
		return "readinessKind=" + readinessKind + ";decisionCount=" + decisionCount + ";admittedCount=" + admittedCount + ";postRenderIdleListReady="
			...
			+ boolLabel(completionReady) + ";nextSliceReady=" + boolLabel(nextSliceReady) + ";replayCount=" + replayCount + ";sourceReplayCount="
			+ sourceReplayCount + ";sourceHandoffReplayCount=" + sourceHandoffReplayCount + ";sourceHandoffReadinessDecisionCount="
			...
			+ ";finalSnapshot=" + finalSnapshot.split("\n").join("\\n") + ";readiness=[" + readinessSummary + "]" + ";decisions=["
