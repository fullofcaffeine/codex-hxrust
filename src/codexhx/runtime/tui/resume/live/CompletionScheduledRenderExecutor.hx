...
class CompletionScheduledRenderExecutor {
	...
	public function execute(report:CompletionRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
	...
	function executeReady(report:CompletionRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
	...
	function rejected(report:CompletionRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
		return new CompletionScheduledRenderExecution({
