...
class ResumePickerReloadScrollPreservationRenderGate {
	public static function run():ResumePickerReloadScrollPreservationRenderGateReport {
		...
		return new ResumePickerReloadScrollPreservationRenderGateReport({
			pageLoads: pageLoads,
