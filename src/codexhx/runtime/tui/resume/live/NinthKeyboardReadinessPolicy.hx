...
class NinthKeyboardReadinessPolicy {
	...
	public function admit(report:EighthExecutionHandoffReport, intents:Array<RecoveryKeyboardIntentKind>):RecoveryReplayAwareKeyboardReadiness {
	...
	function sourceReady(report:EighthExecutionHandoffReport):Bool {
	...
	function decide(report:EighthExecutionHandoffReport, intent:RecoveryKeyboardIntentKind, ready:Bool):RecoveryKeyboardDecision {
