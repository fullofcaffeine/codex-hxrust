...
class SixthKeyboardReadinessGate {
	public static function run():SixthKeyboardReadinessReport {
		final handoffReport = FifthExecutionHandoffGate.run();
		final policy = new SixthKeyboardReadinessPolicy();
		final readiness = policy.admit(handoffReport, [RecoveryKeyboardIntentKind.MoveDown, RecoveryKeyboardIntentKind.MoveUp]);
		return new SixthKeyboardReadinessReport({
