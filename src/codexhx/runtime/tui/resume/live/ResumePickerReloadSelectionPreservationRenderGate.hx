...
class ResumePickerReloadSelectionPreservationRenderGate {
	public static function run():ResumePickerReloadSelectionPreservationRenderGateReport {
		...
		return new ResumePickerReloadSelectionPreservationRenderGateReport({
			pageLoads: pageLoads,
