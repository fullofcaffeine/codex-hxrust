...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleReplayCompletionHandoffRenderGate {
	public static function run():ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleReplayCompletionHandoffRenderGateReport {
		final replayReport = ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleKeyboardRenderSnapshotReplayRenderGate.run();
		final policy = new DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleReplayCompletionHandoffPolicy();
		final handoff = policy.handoff(replayReport);
		return
			new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSeventhCycleReplayCompletionHandoffRenderGateReport({
			...
			sourceFourthCycleHandoffInputAdmitted: replayReport.sourceFourthCycleHandoffInputAdmitted,
			sourceFourthCycleHandoffLocalOnlyRenderIntent: replayReport.sourceFourthCycleHandoffLocalOnlyRenderIntent,
