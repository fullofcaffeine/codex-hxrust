...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFifthCycleKeyboardRenderStateRenderGate {
	static final FinalFooter = "footer keyboard move_up selected=0 selectedThread=thread-surface-a";

	public static function run():ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFifthCycleKeyboardRenderStateRenderGateReport {
		final readinessReport = ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFifthCycleKeyboardReadinessRenderGate.run();
		...
		return new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFifthCycleKeyboardRenderStateRenderGateReport({
	...
	static function decisionsFrom(readinessReport:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFifthCycleKeyboardReadinessRenderGateReport):Array<ResumePickerAppServerTypedResponseRecoveryKeyboardDecision> {
	...
	static function decision(ready:Bool, intent:ResumePickerAppServerTypedResponseRecoveryKeyboardIntentKind, sequence:Int, selectedBefore:Int,
			...
			readinessReport:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFifthCycleKeyboardReadinessRenderGateReport):ResumePickerAppServerTypedResponseRecoveryKeyboardDecision {
		return new ResumePickerAppServerTypedResponseRecoveryKeyboardDecision({
			...
			reason: ready ? "post_completion_post_render_replay_aware_rendered_state_fifth_cycle_keyboard_render_state_decision_ready" : "post_completion_post_render_replay_aware_rendered_state_fifth_cycle_keyboard_render_state_decision_rejected"
		});
	}
