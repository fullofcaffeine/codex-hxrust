...
class EighthCompletionHandoffGate {
	public static function run():EighthCompletionHandoffReport {
		final replayReport = EighthSnapshotReplayGate.run();
		final policy = new EighthCompletionHandoffPolicy();
		final handoff = policy.handoff(replayReport);
		return new EighthCompletionHandoffReport({
