...
class ResumePickerAppServerResponseDispatchIntentRenderGate {
	...
	public static function run():ResumePickerAppServerResponseDispatchIntentRenderGateReport {
		...
		final pump = new ResumePickerAppServerEventPump(1, fanout, scheduler, 6);
		...
		final refusedIntent = ResumePickerAppServerRequestResponseIntent.refused(refusedEvent.requestId, refusedEvent.detail,
		...
		final resolvedIntent = ResumePickerAppServerRequestResponseIntent.resolved(resolvedEvent.requestId, resolvedEvent.detail, "{\"answer\":\"continue\"}");
		...
		final pagePoll = pump.forward(ResumePickerAppServerStreamEvent.pageResult(1, "response-dispatch-recovery-page", threadListResultJson("dispatch")));
		...
		return new ResumePickerAppServerResponseDispatchIntentRenderGateReport({
			...
			dispatchCommandsTyped: refusedCommand.kind == ResumePickerAppServerRequestDispatchCommandKind.RejectServerRequest
			&& resolvedCommand.kind == ResumePickerAppServerRequestDispatchCommandKind.ResolveServerRequest,
	...
	static function applyResponseDispatch(state:ResumePickerState, event:ResumePickerHostEvent, command:ResumePickerAppServerRequestDispatchCommand,
			status:String):Void {
