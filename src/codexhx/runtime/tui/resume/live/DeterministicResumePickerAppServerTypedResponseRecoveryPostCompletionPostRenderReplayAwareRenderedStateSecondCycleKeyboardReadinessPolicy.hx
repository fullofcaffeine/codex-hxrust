...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleKeyboardReadinessPolicy {
	...
	public function admit(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateScheduledExecutionHandoffRenderGateReport,
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareKeyboardReadiness({
			...
			reason: accepted ? "post_completion_post_render_replay_aware_rendered_state_second_cycle_keyboard_ready" : "post_completion_post_render_replay_aware_rendered_state_second_cycle_keyboard_rejected"
		});
		log.push("postRenderReplayAwareRenderedStateSecondCycleKeyboard:" + out.summary());
		return out;
	}
	...
	function sourceReady(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateScheduledExecutionHandoffRenderGateReport):Bool {
	...
	function decide(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateScheduledExecutionHandoffRenderGateReport,
		...
		final decision = new ResumePickerAppServerTypedResponseRecoveryKeyboardDecision({
			...
			stateDbUntouched: report.stateDbUntouched,
			reason: ready ? "post_completion_post_render_replay_aware_rendered_state_second_cycle_keyboard_navigation_ready" : "navigation_rejected"
		});
