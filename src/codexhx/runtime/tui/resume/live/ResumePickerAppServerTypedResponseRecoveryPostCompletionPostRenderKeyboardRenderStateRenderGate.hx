...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardRenderStateRenderGate {
	static final FinalFooter = "footer keyboard move_up selected=0 selectedThread=thread-surface-a";

	public static function run():ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardRenderStateRenderGateReport {
		final readinessReport = ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardReadinessRenderGate.run();
		...
		return new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardRenderStateRenderGateReport({
	...
	static function decisionsFrom(readinessReport:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardReadinessRenderGateReport):Array<ResumePickerAppServerTypedResponseRecoveryKeyboardDecision> {
	...
	static function decision(ready:Bool, intent:ResumePickerAppServerTypedResponseRecoveryKeyboardIntentKind, sequence:Int, selectedBefore:Int,
			...
			readinessReport:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderKeyboardReadinessRenderGateReport):ResumePickerAppServerTypedResponseRecoveryKeyboardDecision {
