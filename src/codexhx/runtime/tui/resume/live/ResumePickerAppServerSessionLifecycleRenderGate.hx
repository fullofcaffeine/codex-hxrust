...
class ResumePickerAppServerSessionLifecycleRenderGate {
	public static function run():ResumePickerAppServerSessionLifecycleRenderGateReport {
		final firstSource = new JsonRpcResumePickerThreadSource(8);
		final firstSession = new ResumePickerAppServerStreamFanout(firstSource);
		final recoverySource = new JsonRpcResumePickerThreadSource(8);
		final recoverySession = new ResumePickerAppServerStreamFanout(recoverySource);
		...
		return new ResumePickerAppServerSessionLifecycleRenderGateReport({
