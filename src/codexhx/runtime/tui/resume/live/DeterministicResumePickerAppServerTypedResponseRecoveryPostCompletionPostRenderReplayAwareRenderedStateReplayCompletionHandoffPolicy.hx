...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateReplayCompletionHandoffPolicy {
	...
	public function handoff(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateKeyboardRenderSnapshotReplayRenderGateReport):ResumePickerAppServerTypedResponseRecoveryReplayCompletionHandoff {
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryReplayCompletionHandoff({
			...
			reason: completed ? "post_completion_post_render_replay_aware_rendered_state_replay_completed_for_next_slice" : "post_completion_post_render_replay_aware_rendered_state_replay_completion_rejected"
		});
		log.push("post-render-replay-aware-rendered-state-completion:" + out.summary());
		return out;
	}
