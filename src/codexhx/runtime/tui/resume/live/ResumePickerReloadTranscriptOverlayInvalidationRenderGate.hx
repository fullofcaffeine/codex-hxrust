...
class ResumePickerReloadTranscriptOverlayInvalidationRenderGate {
	public static function run():ResumePickerReloadTranscriptOverlayInvalidationRenderGateReport {
		...
		return new ResumePickerReloadTranscriptOverlayInvalidationRenderGateReport({
			pageLoads: pageLoads,
