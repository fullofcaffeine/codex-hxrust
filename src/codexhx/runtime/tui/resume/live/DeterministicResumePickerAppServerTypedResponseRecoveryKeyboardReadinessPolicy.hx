...
class DeterministicResumePickerAppServerTypedResponseRecoveryKeyboardReadinessPolicy {
	...
	public function admit(report:ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffRenderGateReport,
			intent:ResumePickerAppServerTypedResponseRecoveryKeyboardIntentKind):ResumePickerAppServerTypedResponseRecoveryKeyboardDecision {
