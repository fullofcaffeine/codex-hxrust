...
class SeventhInputAdmissionGate {
	public static function run():SeventhInputAdmissionReport {
		final completionReport = SeventhCompletionHandoffGate.run();
		final policy = new SeventhInputAdmissionPolicy();
		final admission = policy.admit(completionReport, CompletionInputIntentKind.ConfirmRecoveredSelection);
		return new SeventhInputAdmissionReport({
