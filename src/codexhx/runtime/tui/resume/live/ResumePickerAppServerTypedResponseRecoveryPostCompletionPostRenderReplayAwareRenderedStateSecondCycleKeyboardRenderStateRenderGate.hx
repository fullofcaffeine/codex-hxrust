...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleKeyboardRenderStateRenderGate {
	static final FinalFooter = "footer keyboard move_up selected=0 selectedThread=thread-surface-a";

	public static function run():ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleKeyboardRenderStateRenderGateReport {
		final readinessReport = ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleKeyboardReadinessRenderGate.run();
		...
		return new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleKeyboardRenderStateRenderGateReport({
	...
	static function decisionsFrom(readinessReport:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleKeyboardReadinessRenderGateReport):Array<ResumePickerAppServerTypedResponseRecoveryKeyboardDecision> {
	...
	static function decision(ready:Bool, intent:ResumePickerAppServerTypedResponseRecoveryKeyboardIntentKind, sequence:Int, selectedBefore:Int,
			...
			readinessReport:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleKeyboardReadinessRenderGateReport):ResumePickerAppServerTypedResponseRecoveryKeyboardDecision {
		return new ResumePickerAppServerTypedResponseRecoveryKeyboardDecision({
			...
			reason: ready ? "post_completion_post_render_replay_aware_rendered_state_second_cycle_keyboard_render_state_decision_ready" : "post_completion_post_render_replay_aware_rendered_state_second_cycle_keyboard_render_state_decision_rejected"
		});
	}
