...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSixthCycleInputAdmissionPolicy {
	...
	public function admit(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSixthCycleReplayCompletionHandoffRenderGateReport,
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryPostCompletionInputAdmission({
			...
			reason: ready ? "post_completion_post_render_replay_aware_rendered_state_sixth_cycle_input_admitted_after_replay" : "post_completion_post_render_replay_aware_rendered_state_sixth_cycle_input_rejected_before_replay"
		});
		nextSequence = nextSequence + 1;
		log.push("postRenderReplayAwareRenderedStateSixthCycleInput:" + out.summary());
		return out;
	}
