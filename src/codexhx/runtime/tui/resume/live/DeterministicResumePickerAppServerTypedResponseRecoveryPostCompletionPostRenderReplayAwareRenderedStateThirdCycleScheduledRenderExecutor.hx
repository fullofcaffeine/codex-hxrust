...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleScheduledRenderExecutor {
	...
	public function execute(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleRenderRequestSchedulingRenderGateReport,
		...
		log.push("postRenderReplayAwareRenderedStateThirdCycleScheduledExecution:" + execution.summary());
		return execution;
	}

	function executeReady(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleRenderRequestSchedulingRenderGateReport,
			renderer:DeterministicResumePickerTerminalRenderer):ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecution {
		...
		return new ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecution({
			...
			reason: rendered ? "post_completion_post_render_replay_aware_rendered_state_third_cycle_local_render_request_executed" : "post_completion_post_render_replay_aware_rendered_state_third_cycle_local_render_request_execution_failed"
		});
	}

	function rejected(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleRenderRequestSchedulingRenderGateReport,
			renderer:DeterministicResumePickerTerminalRenderer):ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecution {
		return new ResumePickerAppServerTypedResponseRecoveryPostCompletionScheduledRenderExecution({
			...
			noFilesystemMutation: report.noFilesystemMutation,
			renderedSnapshot: "",
			reason: "post_completion_post_render_replay_aware_rendered_state_third_cycle_local_render_request_execution_rejected"
		});
	}
