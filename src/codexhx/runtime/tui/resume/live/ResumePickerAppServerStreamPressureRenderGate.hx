...
class ResumePickerAppServerStreamPressureRenderGate {
	public static function run():ResumePickerAppServerStreamPressureRenderGateReport {
		...
		final pump = new ResumePickerAppServerEventPump(1, fanout, scheduler, 2);
		...
		forwardPolls.push("frame=" + AsyncPollSummary.summary(pump.forward(ResumePickerAppServerStreamEvent.frameRequested(1, "pressure-frame-1"))));
		forwardPolls.push("progress=" + AsyncPollSummary.summary(pump.forward(ResumePickerAppServerStreamEvent.progressUpdated(1, "cosmetic-progress"))));
		final droppedServerPoll = pump.forward(ResumePickerAppServerStreamEvent.serverRequest(1, "pressure-server-request-dropped",
			"approval request while queue full"));
		forwardPolls.push("server-request=" + AsyncPollSummary.summary(droppedServerPoll));
		final blockedReadPoll = pump.forward(ResumePickerAppServerStreamEvent.readResult(1, "pressure-read-lossless", "thread-pressure-a",
		...
		final readPoll = pump.forward(ResumePickerAppServerStreamEvent.readResult(1, "pressure-read-lossless", "thread-pressure-a",
			threadReadResultJson("thread-pressure-a", "user: stream pressure\nassistant: lossless survived")));
		...
		forwardPolls.push("page-recovery="
			+ AsyncPollSummary.summary(pump.forward(ResumePickerAppServerStreamEvent.pageResult(1, "pressure-recovery-page",
				threadListResultJson("pressure")))));
		...
		return new ResumePickerAppServerStreamPressureRenderGateReport({
