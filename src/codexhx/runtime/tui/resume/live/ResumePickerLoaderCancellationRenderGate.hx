...
class ResumePickerLoaderCancellationRenderGate {
	public static function run():ResumePickerLoaderCancellationRenderGateReport {
		...
		return new ResumePickerLoaderCancellationRenderGateReport({
			pageLoads: pageLoads,
