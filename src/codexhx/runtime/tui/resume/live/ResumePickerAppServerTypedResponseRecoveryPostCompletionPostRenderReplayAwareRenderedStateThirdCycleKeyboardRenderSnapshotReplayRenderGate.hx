...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleKeyboardRenderSnapshotReplayRenderGate {
	public static function run():ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleKeyboardRenderSnapshotReplayRenderGateReport {
		final sourceReport = ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleKeyboardRenderStateRenderGate.run();
		final replays = replay(sourceReport);
		final snapshots = replayedSnapshots(replays);

		return
			new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleKeyboardRenderSnapshotReplayRenderGateReport({
			...
			sourceHandoffReplayCount: sourceReport.sourceReplayCount,
			sourceHandoffReadinessDecisionCount: sourceReport.sourceReadinessDecisionCount,
			sourceHandoffRenderStateCount: sourceReport.sourceRenderStateCount,
			sourceHandoffFrameRequests: sourceReport.sourceFrameRequests,
			sourceHandoffKeyboardRenderCount: sourceReport.sourceKeyboardRenderCount,
			sourceSecondCycleHandoffReplayCount: sourceReport.sourceHandoffReplayCount,
			sourceSecondCycleHandoffReadinessDecisionCount: sourceReport.sourceHandoffReadinessDecisionCount,
			sourceSecondCycleHandoffRenderStateCount: sourceReport.sourceHandoffRenderStateCount,
			sourceSecondCycleHandoffFrameRequests: sourceReport.sourceHandoffFrameRequests,
			sourceSecondCycleHandoffKeyboardRenderCount: sourceReport.sourceHandoffKeyboardRenderCount,
			sourceThirdCycleHandoffReplayCount: sourceReport.sourceSecondCycleHandoffReplayCount,
			sourceThirdCycleHandoffReadinessDecisionCount: sourceReport.sourceSecondCycleHandoffReadinessDecisionCount,
			sourceThirdCycleHandoffRenderStateCount: sourceReport.sourceSecondCycleHandoffRenderStateCount,
			sourceThirdCycleHandoffFrameRequests: sourceReport.sourceSecondCycleHandoffFrameRequests,
			sourceThirdCycleHandoffKeyboardRenderCount: sourceReport.sourceSecondCycleHandoffKeyboardRenderCount,
	...
	static function replay(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleKeyboardRenderStateRenderGateReport):Array<ResumePickerAppServerTypedResponseRecoveryRenderSnapshotReplay> {
		return [
	...
	static function entry(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleKeyboardRenderStateRenderGateReport,
		...
		return new ResumePickerAppServerTypedResponseRecoveryRenderSnapshotReplay({
			...
			snapshot: snapshot,
			reason: "post_completion_post_render_replay_aware_rendered_state_third_cycle_keyboard_snapshot_replayed"
		});
	}
