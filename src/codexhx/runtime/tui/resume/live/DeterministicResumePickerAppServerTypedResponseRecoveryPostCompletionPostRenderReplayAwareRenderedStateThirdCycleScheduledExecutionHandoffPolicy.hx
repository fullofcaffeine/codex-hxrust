...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleScheduledExecutionHandoffPolicy {
	...
	public function handoff(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleScheduledRenderExecutionRenderGateReport):ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderRenderedStateHandoff {
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderRenderedStateHandoff({
			...
			reason: ready ? "post_completion_post_render_replay_aware_rendered_state_third_cycle_scheduled_execution_handed_to_idle_list" : "post_completion_post_render_replay_aware_rendered_state_third_cycle_scheduled_execution_handoff_rejected"
		});
		log.push("postRenderReplayAwareRenderedStateThirdCycleScheduledExecutionHandoff:" + out.summary());
		return out;
	}
