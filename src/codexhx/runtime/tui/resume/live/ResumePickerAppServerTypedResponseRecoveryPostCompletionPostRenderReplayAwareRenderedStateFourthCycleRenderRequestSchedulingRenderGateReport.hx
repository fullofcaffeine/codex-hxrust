...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleRenderRequestSchedulingRenderGateReportFields = {
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleRenderRequestSchedulingRenderGateReport {
	...
	public function summary():String {
		return "scheduleKind=" + scheduleKind + ";scheduleRequested=" + boolLabel(scheduleRequested) + ";scheduled=" + boolLabel(scheduled)
			...
			+ sourceKeyboardRenderCount + ";replayCount=" + replayCount + ";sourceReplayCount=" + sourceReplayCount + ";sourceHandoffReplayCount="
