...
import codexhx.runtime.tui.resume.host.ResumePickerAppServerTypedResponseRecoveryKeyboardRenderStateKind;

class DeterministicResumePickerAppServerTypedResponseRecoveryKeyboardRenderStateProjector {
	final scheduler:DeterministicResumePickerFrameScheduler;
	final renderer:DeterministicResumePickerTerminalRenderer;
	final states:Array<ResumePickerAppServerTypedResponseRecoveryKeyboardRenderState>;

	public function new() {
		this.scheduler = new DeterministicResumePickerFrameScheduler();
		this.renderer = new DeterministicResumePickerTerminalRenderer();
		this.states = [];
	}

	public function project(decision:ResumePickerAppServerTypedResponseRecoveryKeyboardDecision):ResumePickerAppServerTypedResponseRecoveryKeyboardRenderState {
		...
		final renderState = new ResumePickerAppServerTypedResponseRecoveryKeyboardRenderState({kind: ResumePickerAppServerTypedResponseRecoveryKeyboardRenderStateKind.NavigationRenderState,
