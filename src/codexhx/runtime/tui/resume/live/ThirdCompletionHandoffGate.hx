...
class ThirdCompletionHandoffGate {
	public static function run():ThirdCompletionHandoffReport {
		final replayReport = ThirdSnapshotReplayGate.run();
		final policy = new ThirdCompletionHandoffPolicy();
		final handoff = policy.handoff(replayReport);
		return new ThirdCompletionHandoffReport({
