...
class SixthExecutionHandoffGate {
	public static function run():SixthExecutionHandoffReport {
		final executionReport = SixthScheduledRenderGate.run();
		final policy = new SixthExecutionHandoffPolicy();
		final handoff = policy.handoff(executionReport);
		return new SixthExecutionHandoffReport({
