...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateHandoffRenderGateReportFields = {
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateHandoffRenderGateReport {
	...
	public function summary():String {
		return "handoffKind=" + handoffKind + ";postRenderIdleListReady=" + boolLabel(postRenderIdleListReady) + ";keyboardInputReady="
			...
			+ boolLabel(localOnlyRenderIntent) + ";replayCount=" + replayCount + ";sourceReplayCount=" + sourceReplayCount + ";sourceReadinessDecisionCount="
