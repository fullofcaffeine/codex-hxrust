...
class FourthScheduledRenderExecutor {
	...
	public function execute(report:FourthRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
	...
	function executeReady(report:FourthRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
	...
	function rejected(report:FourthRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
		return new CompletionScheduledRenderExecution({
