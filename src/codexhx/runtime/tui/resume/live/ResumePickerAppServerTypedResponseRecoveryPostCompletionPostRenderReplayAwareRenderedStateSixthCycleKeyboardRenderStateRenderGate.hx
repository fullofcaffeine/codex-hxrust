...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSixthCycleKeyboardRenderStateRenderGate {
	static final FinalFooter = "footer keyboard move_up selected=0 selectedThread=thread-surface-a";

	public static function run():ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSixthCycleKeyboardRenderStateRenderGateReport {
		final readinessReport = ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSixthCycleKeyboardReadinessRenderGate.run();
		...
		return new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSixthCycleKeyboardRenderStateRenderGateReport({
	...
	static function decisionsFrom(readinessReport:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSixthCycleKeyboardReadinessRenderGateReport):Array<ResumePickerAppServerTypedResponseRecoveryKeyboardDecision> {
	...
	static function decision(ready:Bool, intent:ResumePickerAppServerTypedResponseRecoveryKeyboardIntentKind, sequence:Int, selectedBefore:Int,
			...
			readinessReport:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSixthCycleKeyboardReadinessRenderGateReport):ResumePickerAppServerTypedResponseRecoveryKeyboardDecision {
		return new ResumePickerAppServerTypedResponseRecoveryKeyboardDecision({
			...
			reason: ready ? "post_completion_post_render_replay_aware_rendered_state_sixth_cycle_keyboard_render_state_decision_ready" : "post_completion_post_render_replay_aware_rendered_state_sixth_cycle_keyboard_render_state_decision_rejected"
		});
	}
