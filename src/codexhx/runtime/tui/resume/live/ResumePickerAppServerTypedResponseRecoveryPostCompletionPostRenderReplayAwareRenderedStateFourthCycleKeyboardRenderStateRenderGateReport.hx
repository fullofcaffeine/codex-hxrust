...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleKeyboardRenderStateRenderGateReportFields = {
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleKeyboardRenderStateRenderGateReport {
	...
	public function summary():String {
		return "readinessDecisionCount=" + readinessDecisionCount + ";readinessAdmittedCount=" + readinessAdmittedCount + ";renderStateCount="
			...
			+ ";footerSummariesPreserved=" + boolLabel(footerSummariesPreserved) + ";sourceSelectedMarkerMoved=" + boolLabel(sourceSelectedMarkerMoved)
