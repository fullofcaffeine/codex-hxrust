...
class ReplayStateKeyboardStateGate {
	static final FinalFooter = "footer keyboard move_up selected=0 selectedThread=thread-surface-a";

	public static function run():ReplayStateKeyboardStateReport {
		final readinessReport = ReplayStateKeyboardReadinessGate.run();
		...
		return new ReplayStateKeyboardStateReport({
	...
	static function decisionsFrom(readinessReport:ReplayStateKeyboardReadinessReport):Array<RecoveryKeyboardDecision> {
	...
	static function decision(ready:Bool, intent:RecoveryKeyboardIntentKind, sequence:Int, selectedBefore:Int, selectedAfter:Int, threadBefore:String,
			threadAfter:String, rejectedThreadAfter:String, readinessReport:ReplayStateKeyboardReadinessReport):RecoveryKeyboardDecision {
