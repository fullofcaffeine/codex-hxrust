...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderRequestScheduler {
	...
	public function schedule(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareInputRenderIntentRenderGateReport,
		...
		final schedulerReason = ready ? "typed_response_recovery_post_completion_post_render_replay_aware_local_render:thread-surface-a" : "";
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryPostCompletionRenderRequestSchedule({
			...
			reason: scheduled ? "post_completion_post_render_replay_aware_local_render_request_scheduled" : "post_completion_post_render_replay_aware_local_render_request_rejected"
		});
		nextSequence = nextSequence + 1;
		log.push("postRenderReplayAwareRequestSchedule:" + out.summary());
		return out;
	}
