...
class EighthRenderRequestGate {
	public static function run():EighthRenderRequestReport {
		final renderIntentReport = EighthInputRenderIntentGate.run();
		final frameScheduler = new DeterministicFrameScheduler();
		final requestScheduler = new EighthRenderRequestScheduler();
		final schedule = requestScheduler.schedule(renderIntentReport, frameScheduler);
		return new EighthRenderRequestReport({
