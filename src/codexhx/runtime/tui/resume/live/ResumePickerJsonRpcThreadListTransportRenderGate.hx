...
class ResumePickerJsonRpcThreadListTransportRenderGate {
	public static function run():ResumePickerJsonRpcThreadListTransportRenderGateReport {
		...
		return new ResumePickerJsonRpcThreadListTransportRenderGateReport({
