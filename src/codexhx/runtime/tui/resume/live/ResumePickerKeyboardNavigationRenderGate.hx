...
class ResumePickerKeyboardNavigationRenderGate {
	public static function run():ResumePickerKeyboardNavigationRenderGateReport {
		...
		return new ResumePickerKeyboardNavigationRenderGateReport({
