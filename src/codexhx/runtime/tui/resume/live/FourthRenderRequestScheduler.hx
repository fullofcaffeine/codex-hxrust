...
class FourthRenderRequestScheduler {
	...
	public function schedule(report:FourthInputRenderIntentReport, scheduler:DeterministicFrameScheduler):CompletionRenderRequestSchedule {
