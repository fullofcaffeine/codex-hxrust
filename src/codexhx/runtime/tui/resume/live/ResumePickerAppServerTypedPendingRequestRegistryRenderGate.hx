...
import codexhx.runtime.tui.resume.host.ResumePickerAppServerTypedPendingRequestEvent;
import codexhx.runtime.tui.resume.host.ResumePickerAppServerTypedPendingRequestEventKind;
...
class ResumePickerAppServerTypedPendingRequestRegistryRenderGate {
	public static function run():ResumePickerAppServerTypedPendingRequestRegistryRenderGateReport {
		...
		final pump = new ResumePickerAppServerEventPump(1, fanout, scheduler, 14);
		final registry = new DeterministicResumePickerAppServerTypedPendingRequestRegistry();
		final events:Array<ResumePickerAppServerTypedPendingRequestEvent> = [];
		...
		final execRegistered = registry.register(ResumePickerAppServerPendingRequestClassKind.ExecApproval, execHost.requestId, "approval-1", "turn-1",
			"call-1", "", "", execHost.detail);
		...
		final fileRegistered = registry.register(ResumePickerAppServerPendingRequestClassKind.FileChangeApproval, fileHost.requestId, "patch-1", "turn-1",
			"patch-1", "", "", fileHost.detail);
		...
		final permissionsRegistered = registry.register(ResumePickerAppServerPendingRequestClassKind.PermissionsApproval, permissionsHost.requestId, "perm-1",
			"turn-1", "perm-1", "", "", permissionsHost.detail);
		events.push(permissionsRegistered);

		final duplicatePermissions = registry.register(ResumePickerAppServerPendingRequestClassKind.PermissionsApproval, "typed-permissions-duplicate-3b",
			"perm-1", "turn-1", "perm-1", "", "", "item/permissions/requestApproval;item=perm-1;duplicate=true");
		...
		final userInputARegistered = registry.register(ResumePickerAppServerPendingRequestClassKind.UserInput, userInputA.requestId, "turn-2", "turn-2",
			"tool-1", "", "", userInputA.detail);
		...
		final userInputBRegistered = registry.register(ResumePickerAppServerPendingRequestClassKind.UserInput, userInputB.requestId, "turn-2", "turn-2",
			"tool-2", "", "", userInputB.detail);
		...
		final mcpRegistered = registry.register(ResumePickerAppServerPendingRequestClassKind.McpElicitation, mcpHost.requestId, "apps:mcp-6", "turn-3",
			"mcp-item-6", "apps", "mcp-6", mcpHost.detail);
		...
		final unsupported = registry.register(ResumePickerAppServerPendingRequestClassKind.DynamicToolCall, "typed-dynamic-7", "tool-7", "turn-4", "tool-7",
		...
		final execRemoved = registry.resolveKey(ResumePickerAppServerPendingRequestClassKind.ExecApproval, "approval-1");
		final permissionsRemoved = registry.resolveKey(ResumePickerAppServerPendingRequestClassKind.PermissionsApproval, "perm-1");
		...
		final pagePoll = pump.forward(ResumePickerAppServerStreamEvent.pageResult(1, "typed-pending-recovery-page", threadListResultJson("typed")));
		...
		return new ResumePickerAppServerTypedPendingRequestRegistryRenderGateReport({
			typedClassesRegistered: execRegistered.kind == ResumePickerAppServerTypedPendingRequestEventKind.Registered
			&& fileRegistered.kind == ResumePickerAppServerTypedPendingRequestEventKind.Registered
			&& permissionsRegistered.kind == ResumePickerAppServerTypedPendingRequestEventKind.Registered
			&& userInputARegistered.kind == ResumePickerAppServerTypedPendingRequestEventKind.Registered
			&& userInputBRegistered.kind == ResumePickerAppServerTypedPendingRequestEventKind.Registered
			&& mcpRegistered.kind == ResumePickerAppServerTypedPendingRequestEventKind.Registered,
			keyDuplicateRejected: duplicatePermissions.kind == ResumePickerAppServerTypedPendingRequestEventKind.DuplicateRejected
			&& duplicatePermissions.key == "perm-1",
			userInputFifoResolved: fifoFirst.kind == ResumePickerAppServerTypedPendingRequestEventKind.UserInputFifoPopped
			&& fifoFirst.requestId == "typed-user-input-4"
			&& fifoSecond.kind == ResumePickerAppServerTypedPendingRequestEventKind.UserInputFifoPopped
			&& fifoSecond.requestId == "typed-user-input-5",
			mcpRequestMatched: mcpMatched.kind == ResumePickerAppServerTypedPendingRequestEventKind.McpMatched
			&& mcpMatched.serverName == "apps"
			&& mcpMatched.mcpRequestId == "mcp-6",
			unsupportedRefused: unsupported.kind == ResumePickerAppServerTypedPendingRequestEventKind.UnsupportedRefused
			&& unsupported.requestClass == ResumePickerAppServerPendingRequestClassKind.DynamicToolCall,
			notificationRemoved: notificationRemoved.kind == ResumePickerAppServerTypedPendingRequestEventKind.NotificationRemoved
			&& notificationRemoved.requestId == "typed-file-2",
			staleReplaySkipped: staleReplay.kind == ResumePickerAppServerTypedPendingRequestEventKind.StaleReplaySkipped
	...
	static function applyTypedEvent(state:ResumePickerState, event:ResumePickerAppServerTypedPendingRequestEvent, status:String):Void {
		state.inlineErrorShown = event.kind == ResumePickerAppServerTypedPendingRequestEventKind.DuplicateRejected
			|| event.kind == ResumePickerAppServerTypedPendingRequestEventKind.UnsupportedRefused;
	...
	static function typedEventSummaries(events:Array<ResumePickerAppServerTypedPendingRequestEvent>):Array<String> {
