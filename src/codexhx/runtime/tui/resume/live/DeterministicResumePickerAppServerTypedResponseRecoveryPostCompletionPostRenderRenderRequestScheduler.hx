...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderRenderRequestScheduler {
	...
	public function schedule(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderInputRenderIntentRenderGateReport,
