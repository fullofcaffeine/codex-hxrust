...
import codexhx.runtime.tui.resume.host.ResumePickerAppServerTypedResponseRecoveryIdleStateHandoff;
import codexhx.runtime.tui.resume.host.ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffKind;

class DeterministicResumePickerAppServerTypedResponseRecoveryIdleStateHandoffPolicy {
	...
	public function handoff(report:ResumePickerAppServerTypedResponseRecoveryFollowUpActionRenderGateReport):ResumePickerAppServerTypedResponseRecoveryIdleStateHandoff {
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryIdleStateHandoff({
			kind: ready ? ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffKind.IdleListReady : ResumePickerAppServerTypedResponseRecoveryIdleStateHandoffKind.HandoffRejected,
