...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleKeyboardReadinessPolicy {
	...
	public function admit(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleScheduledExecutionHandoffRenderGateReport,
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareKeyboardReadiness({
			...
			reason: accepted ? "post_completion_post_render_replay_aware_rendered_state_fourth_cycle_keyboard_ready" : "post_completion_post_render_replay_aware_rendered_state_fourth_cycle_keyboard_rejected"
		});
		log.push("postRenderReplayAwareRenderedStateFourthCycleKeyboard:" + out.summary());
		return out;
	}
	...
	function sourceReady(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleScheduledExecutionHandoffRenderGateReport):Bool {
	...
	function decide(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateThirdCycleScheduledExecutionHandoffRenderGateReport,
		...
		final decision = new ResumePickerAppServerTypedResponseRecoveryKeyboardDecision({
			...
			stateDbUntouched: report.stateDbUntouched,
			reason: ready ? "post_completion_post_render_replay_aware_rendered_state_fourth_cycle_keyboard_navigation_ready" : "navigation_rejected"
		});
