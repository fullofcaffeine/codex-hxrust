...
import codexhx.runtime.tui.resume.host.ResumePickerAppServerEventPumpDispatch;
import codexhx.runtime.tui.resume.host.ResumePickerAppServerEventPumpDispatchKind;
...
class ResumePickerAppServerEventPumpBoundaryRenderGate {
	public static function run():ResumePickerAppServerEventPumpBoundaryRenderGateReport {
		...
		final firstSource = new JsonRpcResumePickerThreadSource(8);
		final firstFanout = new ResumePickerAppServerStreamFanout(firstSource);
		final recoverySource = new JsonRpcResumePickerThreadSource(8);
		final recoveryFanout = new ResumePickerAppServerStreamFanout(recoverySource);
		final pump = new ResumePickerAppServerEventPump(1, firstFanout, scheduler, 8);
		...
		pump.enqueue(ResumePickerAppServerStreamEvent.frameRequested(1, "stream-page-ready"));
		...
		pump.enqueue(ResumePickerAppServerStreamEvent.pageResult(1, "pump-page-1", threadListResultJson("pump")));
		...
		pump.enqueue(ResumePickerAppServerStreamEvent.readResult(0, "pump-stale-preview", "thread-stale", threadReadResultJson("thread-stale", "stale")));
		...
		pump.enqueue(ResumePickerAppServerStreamEvent.readResult(1, "pump-read-preview", "thread-pump-a",
		...
		pump.enqueue(ResumePickerAppServerStreamEvent.disconnected(1, "event pump disconnected"));
		...
		pump.enqueue(ResumePickerAppServerStreamEvent.pageResult(1, "pump-late-old-page", threadListResultJson("old")));
		...
		pump.enqueue(ResumePickerAppServerStreamEvent.pageResult(2, "pump-recovery-page", threadListResultJson("recovery")));
		...
		return new ResumePickerAppServerEventPumpBoundaryRenderGateReport({
			...
			staleGenerationFiltered: staleDispatch.kind == ResumePickerAppServerEventPumpDispatchKind.StaleIgnored
			&& lateOldDispatch.kind == ResumePickerAppServerEventPumpDispatchKind.StaleIgnored
