...
class FifthInputAdmissionGate {
	public static function run():FifthInputAdmissionReport {
		final completionReport = FifthCompletionHandoffGate.run();
		final policy = new FifthInputAdmissionPolicy();
		final admission = policy.admit(completionReport, CompletionInputIntentKind.ConfirmRecoveredSelection);
		return new FifthInputAdmissionReport({
