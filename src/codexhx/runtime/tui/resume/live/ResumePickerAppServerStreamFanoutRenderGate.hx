...
class ResumePickerAppServerStreamFanoutRenderGate {
	public static function run():ResumePickerAppServerStreamFanoutRenderGateReport {
		final source = new JsonRpcResumePickerThreadSource(2);
		...
		return new ResumePickerAppServerStreamFanoutRenderGateReport({
