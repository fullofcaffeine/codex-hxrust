...
class DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareKeyboardReadinessPolicy {
	...
	public function admit(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderRenderedStateHandoffRenderGateReport,
		...
		final replayEvidencePreserved = report.replayCount == 2 && report.snapshotOrderPreserved && report.selectedMarkersPreserved
			&& report.footerSummariesPreserved && report.selectedMarkerMoved && report.recoveredSelectionRestored;
		...
		final out = new ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareKeyboardReadiness({
			...
			reason: accepted ? "post_completion_post_render_replay_aware_keyboard_ready" : "post_completion_post_render_replay_aware_keyboard_rejected"
		});
		log.push("postRenderReplayAwareKeyboard:" + out.summary());
		return out;
	}
	...
	function sourceReady(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderRenderedStateHandoffRenderGateReport):Bool {
	...
	function decide(report:ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderRenderedStateHandoffRenderGateReport,
		...
		final decision = new ResumePickerAppServerTypedResponseRecoveryKeyboardDecision({
			...
			stateDbUntouched: report.stateDbUntouched,
			reason: ready ? "post_completion_post_render_replay_aware_keyboard_navigation_ready" : "navigation_rejected"
		});
