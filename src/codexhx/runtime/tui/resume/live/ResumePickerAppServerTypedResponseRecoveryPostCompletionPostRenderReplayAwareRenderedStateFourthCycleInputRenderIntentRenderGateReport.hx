...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleInputRenderIntentRenderGateReportFields = {
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateFourthCycleInputRenderIntentRenderGateReport {
	...
	public function summary():String {
		return "renderIntentKind=" + renderIntentKind + ";renderRequested=" + boolLabel(renderRequested) + ";localOnlyRenderIntent="
			...
			+ boolLabel(noModelCall) + ";noFilesystemMutation=" + boolLabel(noFilesystemMutation) + ";renderIntent=[" + renderIntentSummary + "]"
			+ ";finalSnapshot=" + finalSnapshot.split("\n").join("\\n") + ";renderIntentLog=[" + renderIntentLogSummaries.join("##") + "]" + ";admission=["
			+ admissionSummary + "]";
	}
