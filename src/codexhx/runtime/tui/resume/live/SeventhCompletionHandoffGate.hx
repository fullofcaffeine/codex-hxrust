...
class SeventhCompletionHandoffGate {
	public static function run():SeventhCompletionHandoffReport {
		final replayReport = SeventhSnapshotReplayGate.run();
		final policy = new SeventhCompletionHandoffPolicy();
		final handoff = policy.handoff(replayReport);
		return new SeventhCompletionHandoffReport({
