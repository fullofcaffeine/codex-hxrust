...
import codexhx.runtime.tui.resume.host.ResumePickerAppServerTypedResponseEnvelopeKind;
import codexhx.runtime.tui.resume.host.ResumePickerAppServerTypedResponsePayloadKind;
...
class ResumePickerAppServerTypedResponsePayloadEnvelopeRenderGate {
	public static function run():ResumePickerAppServerTypedResponsePayloadEnvelopeRenderGateReport {
		...
		final exec = resolveKeyed(pump, registry, builder, events, envelopes, dispatchSummaries, hostEvents, forwardPolls,
			ResumePickerAppServerPendingRequestClassKind.ExecApproval, "typed-response-exec-1", "approval-1", "turn-1", "call-1", "", "",
		...
		final file = resolveKeyed(pump, registry, builder, events, envelopes, dispatchSummaries, hostEvents, forwardPolls,
			ResumePickerAppServerPendingRequestClassKind.FileChangeApproval, "typed-response-file-2", "patch-1", "turn-1", "patch-1", "", "",
		...
		final permissions = resolveKeyed(pump, registry, builder, events, envelopes, dispatchSummaries, hostEvents, forwardPolls,
			ResumePickerAppServerPendingRequestClassKind.PermissionsApproval, "typed-response-permissions-3", "perm-1", "turn-1", "perm-1", "", "",
		...
		final unsupportedEvent = registry.register(ResumePickerAppServerPendingRequestClassKind.DynamicToolCall, "typed-response-dynamic-6", "tool-6",
		...
		final pagePoll = pump.forward(ResumePickerAppServerStreamEvent.pageResult(1, "typed-response-recovery-page", threadListResultJson("response")));
		...
		return new ResumePickerAppServerTypedResponsePayloadEnvelopeRenderGateReport({
			execPayloadRecorded: exec.payloadKind == ResumePickerAppServerTypedResponsePayloadKind.CommandExecutionApprovalResponse
			&& contains(envelopeSummaries, "\"decision\":\"accept\""),
			filePayloadRecorded: file.payloadKind == ResumePickerAppServerTypedResponsePayloadKind.FileChangeApprovalResponse
			&& contains(envelopeSummaries, "\"decision\":\"apply\""),
			permissionsPayloadRecorded: permissions.payloadKind == ResumePickerAppServerTypedResponsePayloadKind.PermissionsApprovalResponse
			&& contains(envelopeSummaries, "\"scope\":\"session\""),
			userInputPayloadRecorded: userInput.payloadKind == ResumePickerAppServerTypedResponsePayloadKind.ToolRequestUserInputResponse
			&& contains(envelopeSummaries, "\"answers\"")
			&& contains(envelopeSummaries, "\"itemId\":\"tool-1\""),
			mcpPayloadRecorded: mcp.payloadKind == ResumePickerAppServerTypedResponsePayloadKind.McpElicitationResponse
			&& contains(envelopeSummaries, "\"action\":\"accept\"")
			&& contains(envelopeSummaries, "\"server\":\"apps\""),
			unsupportedErrorRecorded: unsupported.kind == ResumePickerAppServerTypedResponseEnvelopeKind.RejectError
			&& unsupported.errorJson.indexOf("unsupported_request_class") >= 0,
			missingPendingNoopRecorded: missing.kind == ResumePickerAppServerTypedResponseEnvelopeKind.MissingPendingNoop
			&& missing.localOnly,
	...
	static function resolveKeyed(pump:ResumePickerAppServerEventPump, registry:DeterministicResumePickerAppServerTypedPendingRequestRegistry,
			...
			envelopes:Array<ResumePickerAppServerTypedResponseEnvelope>, dispatchSummaries:Array<String>, hostEvents:Array<String>,
	...
	static function applyEnvelope(state:ResumePickerState, envelope:ResumePickerAppServerTypedResponseEnvelope, status:String):Void {
		state.inlineErrorShown = envelope.kind == ResumePickerAppServerTypedResponseEnvelopeKind.RejectError;
