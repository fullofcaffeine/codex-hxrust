...
class SecondKeyboardReadinessPolicy {
	...
	public function admit(report:ReplayStateExecutionHandoffReport, intents:Array<RecoveryKeyboardIntentKind>):RecoveryReplayAwareKeyboardReadiness {
	...
	function sourceReady(report:ReplayStateExecutionHandoffReport):Bool {
	...
	function decide(report:ReplayStateExecutionHandoffReport, intent:RecoveryKeyboardIntentKind, ready:Bool):RecoveryKeyboardDecision {
