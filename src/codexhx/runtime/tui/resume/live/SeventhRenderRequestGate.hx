...
class SeventhRenderRequestGate {
	public static function run():SeventhRenderRequestReport {
		final renderIntentReport = SeventhInputRenderIntentGate.run();
		final frameScheduler = new DeterministicFrameScheduler();
		final requestScheduler = new SeventhRenderRequestScheduler();
		final schedule = requestScheduler.schedule(renderIntentReport, frameScheduler);
		return new SeventhRenderRequestReport({
