...
class FifthCompletionHandoffGate {
	public static function run():FifthCompletionHandoffReport {
		final replayReport = FifthSnapshotReplayGate.run();
		final policy = new FifthCompletionHandoffPolicy();
		final handoff = policy.handoff(replayReport);
		return new FifthCompletionHandoffReport({
