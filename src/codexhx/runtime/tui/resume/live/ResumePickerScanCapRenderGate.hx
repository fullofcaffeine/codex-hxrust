...
class ResumePickerScanCapRenderGate {
	public static function run():ResumePickerScanCapRenderGateReport {
		...
		return new ResumePickerScanCapRenderGateReport({
			pageLoads: pageLoads,
	...
	static function loadPage(loader:DeterministicResumePickerBackgroundLoader, requestId:String, cursor:String):ResumePickerHostEvent {
