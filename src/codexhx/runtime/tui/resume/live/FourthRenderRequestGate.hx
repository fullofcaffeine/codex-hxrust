...
class FourthRenderRequestGate {
	public static function run():FourthRenderRequestReport {
		final renderIntentReport = FourthInputRenderIntentGate.run();
		final frameScheduler = new DeterministicFrameScheduler();
		final requestScheduler = new FourthRenderRequestScheduler();
		final schedule = requestScheduler.schedule(renderIntentReport, frameScheduler);
		return new FourthRenderRequestReport({
