...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleKeyboardRenderStateRenderGateReportFields = {
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateSecondCycleKeyboardRenderStateRenderGateReport {
	...
	public function summary():String {
		return "readinessDecisionCount=" + readinessDecisionCount + ";readinessAdmittedCount=" + readinessAdmittedCount + ";renderStateCount="
			...
			+ ";decisions=[" + decisionSummaries.join("##") + "]" + ";renderStates=[" + renderStateSummaries.join("##") + "]" + ";finalSnapshot="
