...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionInputAdmissionRenderGate {
	public static function run():ResumePickerAppServerTypedResponseRecoveryPostCompletionInputAdmissionRenderGateReport {
		final completionReport = ResumePickerAppServerTypedResponseRecoveryReplayCompletionHandoffRenderGate.run();
		final policy = new DeterministicResumePickerAppServerTypedResponseRecoveryPostCompletionInputAdmissionPolicy();
		...
		return new ResumePickerAppServerTypedResponseRecoveryPostCompletionInputAdmissionRenderGateReport({
