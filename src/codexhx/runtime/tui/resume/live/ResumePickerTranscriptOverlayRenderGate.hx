...
class ResumePickerTranscriptOverlayRenderGate {
	public static function run():ResumePickerTranscriptOverlayRenderGateReport {
		...
		return new ResumePickerTranscriptOverlayRenderGateReport({
