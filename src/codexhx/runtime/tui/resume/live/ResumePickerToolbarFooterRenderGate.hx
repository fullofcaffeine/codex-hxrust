...
class ResumePickerToolbarFooterRenderGate {
	public static function run():ResumePickerToolbarFooterRenderGateReport {
		...
		return new ResumePickerToolbarFooterRenderGateReport({
