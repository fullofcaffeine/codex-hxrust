...
typedef ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateScheduledExecutionHandoffRenderGateReportFields = {
...
class ResumePickerAppServerTypedResponseRecoveryPostCompletionPostRenderReplayAwareRenderedStateScheduledExecutionHandoffRenderGateReport {
	...
	public function summary():String {
		return "handoffKind=" + handoffKind + ";postRenderIdleListReady=" + boolLabel(postRenderIdleListReady) + ";keyboardInputReady="
			...
			+ sourceHandoffKeyboardRenderCount + ";sourceReadinessDecisionCount=" + sourceReadinessDecisionCount + ";sourceRenderStateCount="
			...
			+ ";sourceHandoffLocalOnlyRenderIntent=" + boolLabel(sourceHandoffLocalOnlyRenderIntent) + ";stalePromptActionInactive="
