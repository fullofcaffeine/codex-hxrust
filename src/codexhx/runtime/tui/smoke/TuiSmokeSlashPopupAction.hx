...
typedef TuiSmokeSlashPopupActionFields = {
	...
	final canonicalCommandText:String;
	final recalledText:String;
	final inlineArgs:String;
	...
	final leadingSpaceInput:Bool;
	final inlineArgsTrimmed:Bool;
	final commandElementStored:Bool;
	final commandElementRemoved:Bool;
	final cursorAtEnd:Bool;
	final appEventEmitted:Bool;
...
class TuiSmokeSlashPopupAction {
	...
	public final canonicalCommandText:String;
	public final recalledText:String;
	public final inlineArgs:String;
	...
	public final leadingSpaceInput:Bool;
	public final inlineArgsTrimmed:Bool;
	public final commandElementStored:Bool;
	public final commandElementRemoved:Bool;
	public final cursorAtEnd:Bool;
	public final appEventEmitted:Bool;
