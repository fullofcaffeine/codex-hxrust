...
typedef TuiSmokePendingThreadApprovalsPlanFields = {
	...
	final actions:Array<TuiSmokePendingThreadApprovalsAction>;
}

@:build(codexhx.macros.FieldRecordConstructor.build())
class TuiSmokePendingThreadApprovalsPlan {
	...
	public final actions:Array<TuiSmokePendingThreadApprovalsAction>;
