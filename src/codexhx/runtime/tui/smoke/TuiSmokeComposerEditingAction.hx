...
typedef TuiSmokeComposerEditingActionFields = {
	...
	final emptyNoop:Bool;
	final historyRecorded:Bool;
	final appHistoryAppended:Bool;
	final quitHintShown:Bool;
	final bottomPaneConsumed:Bool;
	final chatWidgetConsumed:Bool;
...
class TuiSmokeComposerEditingAction {
	...
	public final emptyNoop:Bool;
	public final historyRecorded:Bool;
	public final appHistoryAppended:Bool;
	public final quitHintShown:Bool;
	public final bottomPaneConsumed:Bool;
	public final chatWidgetConsumed:Bool;
