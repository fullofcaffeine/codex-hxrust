...
enum abstract TuiSmokeEventKind(String) to String {
	...
	final ChatWidgetAppServerTurnState = "chat_widget_app_server_turn_state";
	final ChatWidgetAppServerElicitation = "chat_widget_app_server_elicitation";
	...
	final MultiSelectPicker = "multi_select_picker";
	...
	final ThreadStartedSession = "thread_started_session";
	final ThreadReadSession = "thread_read_session";
	...
	public static function fromString(value:String):TuiSmokeEventKind {
		return switch value {
			...
			case "chat_widget_app_server_turn_state": ChatWidgetAppServerTurnState;
			case "chat_widget_app_server_elicitation": ChatWidgetAppServerElicitation;
			...
			case "multi_select_picker": MultiSelectPicker;
			...
			case "thread_started_session": ThreadStartedSession;
			case "thread_read_session": ThreadReadSession;
