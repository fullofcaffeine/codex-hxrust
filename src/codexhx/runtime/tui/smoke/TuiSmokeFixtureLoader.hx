	...
	static function pendingThreadApprovalsActions(values:Array<Value>):Array<TuiSmokePendingThreadApprovalsAction> {
		...
		for (value in values) {
			out.push(new TuiSmokePendingThreadApprovalsAction({
				...
				expectedHeight: optionalIntField(value, "expectedHeight", 0),
				expectedRows: optionalStringArrayField(value, "expectedRows"),
				mainThreadId: optionalStringField(value, "mainThreadId", ""),
				agentThreadId: optionalStringField(value, "agentThreadId", ""),
				agentLabel: optionalStringField(value, "agentLabel", ""),
				requestKind: optionalStringField(value, "requestKind", ""),
				...
				turnCompletedMatched: optionalBoolField(value, "turnCompletedMatched", false),
				inactiveThread: optionalBoolField(value, "inactiveThread", false),
				activeThreadPreserved: optionalBoolField(value, "activeThreadPreserved", false),
				badgeCleared: optionalBoolField(value, "badgeCleared", false),
				failureCode: optionalStringField(value, "failureCode", ""),
				noTerminalMutation: optionalBoolField(value, "noTerminalMutation", false),
				noRatatuiBuffer: optionalBoolField(value, "noRatatuiBuffer", false),
				noFilesystemMutation: optionalBoolField(value, "noFilesystemMutation", false),
	...
	static function appServerElicitationActions(values:Array<Value>):Array<TuiSmokeAppServerElicitationAction> {
		...
		for (value in values) {
			out.push(new TuiSmokeAppServerElicitationAction({
				...
				title: optionalStringField(value, "title", ""),
				description: optionalStringField(value, "description", ""),
				interactiveRequestKind: optionalStringField(value, "interactiveRequestKind", ""),
				...
				requestReturned: optionalBoolField(value, "requestReturned", false),
				appLinkTargetPresent: optionalBoolField(value, "appLinkTargetPresent", false),
	...
	static function appServerErrorActions(values:Array<Value>):Array<TuiSmokeAppServerErrorAction> {
		...
		for (value in values) {
			out.push(new TuiSmokeAppServerErrorAction({
				...
				failureCode: optionalStringField(value, "failureCode", ""),
				methodFragment: optionalStringField(value, "methodFragment", ""),
				invalidConfigFragment: optionalStringField(value, "invalidConfigFragment", ""),
	...
	static function appServerLifecycleActions(values:Array<Value>):Array<TuiSmokeAppServerLifecycleAction> {
		...
		for (value in values) {
			out.push(new TuiSmokeAppServerLifecycleAction({
				...
				threadId: optionalStringField(value, "threadId", ""),
				incomingThreadId: optionalStringField(value, "incomingThreadId", ""),
				originalThreadName: optionalStringField(value, "originalThreadName", ""),
				incomingThreadName: optionalStringField(value, "incomingThreadName", ""),
				finalThreadName: optionalStringField(value, "finalThreadName", ""),
				resumeCommand: optionalStringField(value, "resumeCommand", ""),
				renderedHint: optionalStringField(value, "renderedHint", ""),
				replayKind: optionalStringField(value, "replayKind", ""),
				exitMode: TuiSmokeExitMode.fromString(optionalStringField(value, "exitMode", "unknown")),
				failureCode: optionalStringField(value, "failureCode", ""),
				...
				invalidThreadIdRejected: optionalBoolField(value, "invalidThreadIdRejected", false),
				threadIdPreserved: optionalBoolField(value, "threadIdPreserved", false),
				threadNamePreserved: optionalBoolField(value, "threadNamePreserved", false),
				threadNameUpdated: optionalBoolField(value, "threadNameUpdated", false),
				resumeHintInserted: optionalBoolField(value, "resumeHintInserted", false),
	...
	static function agentNavigationActions(values:Array<Value>):Array<TuiSmokeAgentNavigationAction> {
		...
		for (value in values) {
			out.push(new TuiSmokeAgentNavigationAction({
				...
				loadedThreads: loadedThreads(optionalArrayField(value, "loadedThreads")),
				lastBackfillPrimaryThreadId: optionalStringField(value, "lastBackfillPrimaryThreadId", ""),
				expectedBackfillAttempted: optionalBoolField(value, "expectedBackfillAttempted", false),
				expectedBackfillSucceeded: optionalBoolField(value, "expectedBackfillSucceeded", false),
				expectedLastBackfillPrimaryThreadId: optionalStringField(value, "expectedLastBackfillPrimaryThreadId", ""),
				failureCode: optionalStringField(value, "failureCode", ""),
				noModelCall: optionalBoolField(value, "noModelCall", false),
				noAppServerMutation: optionalBoolField(value, "noAppServerMutation", false),
				noFilesystemMutation: optionalBoolField(value, "noFilesystemMutation", false),
	...
	static function resumeForkActions(values:Array<Value>):Array<TuiSmokeResumeForkAction> {
		...
		for (value in values) {
			out.push(new TuiSmokeResumeForkAction({
				...
				activeReceiverPresent: optionalBoolField(value, "activeReceiverPresent", false),
				stopWaitingForInitialSession: optionalBoolField(value, "stopWaitingForInitialSession", false),
				queuedActiveThreadEvent: optionalBoolField(value, "queuedActiveThreadEvent", false),
				activeEventDispatched: optionalBoolField(value, "activeEventDispatched", false),
	...
	static function sideConversationActions(values:Array<Value>):Array<TuiSmokeSideConversationAction> {
		...
		for (value in values) {
			out.push(new TuiSmokeSideConversationAction({
				...
				replayRoute: TuiSmokeThreadSnapshotReplayRoute.fromString(optionalStringField(value, "replayRoute", "unknown")),
				activeEventKind: TuiSmokeActiveThreadEventKind.fromString(optionalStringField(value, "activeEventKind", "unknown")),
				shutdownRoute: TuiSmokeActiveThreadShutdownRoute.fromString(optionalStringField(value, "shutdownRoute", "unknown")),
				skillsListRoute: TuiSmokeSkillsListResponseRoute.fromString(optionalStringField(value, "skillsListRoute", "unknown")),
				parentThreadId: optionalStringField(value, "parentThreadId", ""),
				childThreadId: optionalStringField(value, "childThreadId", ""),
				...
				primaryThreadId: optionalStringField(value, "primaryThreadId", ""),
				closedThreadId: optionalStringField(value, "closedThreadId", ""),
				pendingShutdownThreadId: optionalStringField(value, "pendingShutdownThreadId", ""),
				cwd: optionalStringField(value, "cwd", ""),
				status: optionalStringField(value, "status", ""),
				...
				replayTurnCount: optionalIntField(value, "replayTurnCount", 0),
				replayEventCount: optionalIntField(value, "replayEventCount", 0),
				replayNoticeCount: optionalIntField(value, "replayNoticeCount", 0),
				replaySuppressedNoticeCount: optionalIntField(value, "replaySuppressedNoticeCount", 0),
				skillCount: optionalIntField(value, "skillCount", 0),
				cwdSkillErrorCount: optionalIntField(value, "cwdSkillErrorCount", 0),
				newlyActiveWarningCount: optionalIntField(value, "newlyActiveWarningCount", 0),
				cachedWarningCount: optionalIntField(value, "cachedWarningCount", 0),
				emittedWarningEventCount: optionalIntField(value, "emittedWarningEventCount", 0),
				remoteImageCount: optionalIntField(value, "remoteImageCount", 0),
				localImageCount: optionalIntField(value, "localImageCount", 0),
				...
				approvalPolicyInherited: optionalBoolField(value, "approvalPolicyInherited", false),
				sandboxPolicyInherited: optionalBoolField(value, "sandboxPolicyInherited", false),
				developerInstructionsAdded: optionalBoolField(value, "developerInstructionsAdded", false),
				mainThreadGuardrail: optionalBoolField(value, "mainThreadGuardrail", false),
				inheritedHistoryReferenceOnly: optionalBoolField(value, "inheritedHistoryReferenceOnly", false),
				boundaryInstructionsOnly: optionalBoolField(value, "boundaryInstructionsOnly", false),
				noInheritedTaskContinuation: optionalBoolField(value, "noInheritedTaskContinuation", false),
				toolHistoryReferenceOnly: optionalBoolField(value, "toolHistoryReferenceOnly", false),
				nonMutatingInspectionAllowed: optionalBoolField(value, "nonMutatingInspectionAllowed", false),
				mutationRequiresSideRequest: optionalBoolField(value, "mutationRequiresSideRequest", false),
				escalatedPermissionBlocked: optionalBoolField(value, "escalatedPermissionBlocked", false),
				transcriptEmpty: optionalBoolField(value, "transcriptEmpty", false),
				...
				snapshotHasTurns: optionalBoolField(value, "snapshotHasTurns", false),
				snapshotHasEvents: optionalBoolField(value, "snapshotHasEvents", false),
				bufferReplayStarted: optionalBoolField(value, "bufferReplayStarted", false),
				bufferReplayEnded: optionalBoolField(value, "bufferReplayEnded", false),
				pendingInteractiveRequest: optionalBoolField(value, "pendingInteractiveRequest", false),
				sessionHandled: optionalBoolField(value, "sessionHandled", false),
				queueAutosendSuppressedBefore: optionalBoolField(value, "queueAutosendSuppressedBefore", false),
				queueAutosendSuppressedAfter: optionalBoolField(value, "queueAutosendSuppressedAfter", false),
				turnsReplayed: optionalBoolField(value, "turnsReplayed", false),
				eventsReplayed: optionalBoolField(value, "eventsReplayed", false),
				noticesSuppressed: optionalBoolField(value, "noticesSuppressed", false),
				initialSubmitReleased: optionalBoolField(value, "initialSubmitReleased", false),
				pendingInitialSubmitSubmitted: optionalBoolField(value, "pendingInitialSubmitSubmitted", false),
				resumeRestoredQueue: optionalBoolField(value, "resumeRestoredQueue", false),
				queuedInputDrained: optionalBoolField(value, "queuedInputDrained", false),
				pendingRequestRegistered: optionalBoolField(value, "pendingRequestRegistered", false),
				notificationDelivered: optionalBoolField(value, "notificationDelivered", false),
				requestDelivered: optionalBoolField(value, "requestDelivered", false),
				requestSkipped: optionalBoolField(value, "requestSkipped", false),
				historyEntryRouted: optionalBoolField(value, "historyEntryRouted", false),
				feedbackRouted: optionalBoolField(value, "feedbackRouted", false),
				collabReceiverCached: optionalBoolField(value, "collabReceiverCached", false),
				rollbackStoreApplied: optionalBoolField(value, "rollbackStoreApplied", false),
				activeReceiverDrained: optionalBoolField(value, "activeReceiverDrained", false),
				activeReceiverRestored: optionalBoolField(value, "activeReceiverRestored", false),
				receiverDisconnected: optionalBoolField(value, "receiverDisconnected", false),
				shutdownNotification: optionalBoolField(value, "shutdownNotification", false),
				nonPrimaryActive: optionalBoolField(value, "nonPrimaryActive", false),
				failoverEligible: optionalBoolField(value, "failoverEligible", false),
				failoverSelectedPrimary: optionalBoolField(value, "failoverSelectedPrimary", false),
				failoverDiscardedSide: optionalBoolField(value, "failoverDiscardedSide", false),
				failoverInfoMessage: optionalBoolField(value, "failoverInfoMessage", false),
				failoverErrorMessage: optionalBoolField(value, "failoverErrorMessage", false),
				pendingShutdownMatched: optionalBoolField(value, "pendingShutdownMatched", false),
				pendingShutdownCleared: optionalBoolField(value, "pendingShutdownCleared", false),
				ordinaryEventForwarded: optionalBoolField(value, "ordinaryEventForwarded", false),
				appExitRequested: optionalBoolField(value, "appExitRequested", false),
				cwdScopedErrors: optionalBoolField(value, "cwdScopedErrors", false),
				newlyActiveFiltered: optionalBoolField(value, "newlyActiveFiltered", false),
				duplicateWarningsSuppressed: optionalBoolField(value, "duplicateWarningsSuppressed", false),
				warningStateCleared: optionalBoolField(value, "warningStateCleared", false),
				warningAppEventEmitted: optionalBoolField(value, "warningAppEventEmitted", false),
				responseForwardedToChatWidget: optionalBoolField(value, "responseForwardedToChatWidget", false),
				skillsAppliedToChatWidget: optionalBoolField(value, "skillsAppliedToChatWidget", false),
				filesystemReadAvoided: optionalBoolField(value, "filesystemReadAvoided", false),
				requestRedraw: optionalBoolField(value, "requestRedraw", false),
				noLiveTerminal: optionalBoolField(value, "noLiveTerminal", false),
				noRatatuiRender: optionalBoolField(value, "noRatatuiRender", false),
				noModelCall: optionalBoolField(value, "noModelCall", false),
	...
	static function toolLifecycleActions(values:Array<Value>):Array<TuiSmokeToolLifecycleAction> {
		...
		for (value in values) {
			out.push(new TuiSmokeToolLifecycleAction({
				...
				tool: optionalStringField(value, "tool", ""),
				path: optionalStringField(value, "path", ""),
				changeKind: optionalStringField(value, "changeKind", ""),
				originalCommand: optionalStringField(value, "originalCommand", ""),
				displayCommand: optionalStringField(value, "displayCommand", ""),
				outputFragment: optionalStringField(value, "outputFragment", ""),
				query: optionalStringField(value, "query", ""),
				action: optionalStringField(value, "action", ""),
				...
				receiverThreadIds: optionalStringField(value, "receiverThreadIds", ""),
				receiverLabels: optionalStringField(value, "receiverLabels", ""),
				receiverStatuses: optionalStringField(value, "receiverStatuses", ""),
				receiverMessages: optionalStringField(value, "receiverMessages", ""),
				requestedModel: optionalStringField(value, "requestedModel", ""),
				requestedReasoningEffort: optionalStringField(value, "requestedReasoningEffort", ""),
				threadId: optionalStringField(value, "threadId", ""),
				summary: optionalStringField(value, "summary", ""),
				failureCode: optionalStringField(value, "failureCode", ""),
				changeCount: optionalIntField(value, "changeCount", 0),
				historyCellCount: optionalIntField(value, "historyCellCount", 0),
				receiverCount: optionalIntField(value, "receiverCount", 0),
				completedReceiverCount: optionalIntField(value, "completedReceiverCount", 0),
				runningReceiverCount: optionalIntField(value, "runningReceiverCount", 0),
				exitCode: optionalIntField(value, "exitCode", 0),
				durationMs: optionalIntField(value, "durationMs", 0),
				...
				pathPreserved: optionalBoolField(value, "pathPreserved", false),
				shellWrapperStripped: optionalBoolField(value, "shellWrapperStripped", false),
				outputPreserved: optionalBoolField(value, "outputPreserved", false),
				receiverMetadataPreserved: optionalBoolField(value, "receiverMetadataPreserved", false),
				promptPreserved: optionalBoolField(value, "promptPreserved", false),
				modelPreserved: optionalBoolField(value, "modelPreserved", false),
				reasoningEffortPreserved: optionalBoolField(value, "reasoningEffortPreserved", false),
				completionModelPresent: optionalBoolField(value, "completionModelPresent", false),
				completionReasoningEffortPresent: optionalBoolField(value, "completionReasoningEffortPresent", false),
				requestedSettingsFromCache: optionalBoolField(value, "requestedSettingsFromCache", false),
				activeCellFlushed: optionalBoolField(value, "activeCellFlushed", false),
				answerStreamFlushed: optionalBoolField(value, "answerStreamFlushed", false),
				historyInserted: optionalBoolField(value, "historyInserted", false),
	...
	static function sessionFlowActions(values:Array<Value>):Array<TuiSmokeSessionFlowAction> {
		...
		for (value in values) {
			out.push(new TuiSmokeSessionFlowAction({
				...
				forkNoticeTitleSource: TuiSmokeForkNoticeTitleSourceKind.fromString(optionalStringField(value, "forkNoticeTitleSource", "")),
				effectiveForkTitle: optionalStringField(value, "effectiveForkTitle", ""),
				localSessionTitle: optionalStringField(value, "localSessionTitle", ""),
				...
				localSessionLookupAttempted: optionalBoolField(value, "localSessionLookupAttempted", false),
				staleLocalTitleIgnored: optionalBoolField(value, "staleLocalTitleIgnored", false),
				idOnlyForkFallback: optionalBoolField(value, "idOnlyForkFallback", false),
				requestRedraw: optionalBoolField(value, "requestRedraw", false),
