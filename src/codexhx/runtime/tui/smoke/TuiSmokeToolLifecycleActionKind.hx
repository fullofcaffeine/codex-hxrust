...
enum abstract TuiSmokeToolLifecycleActionKind(String) to String {
	...
	final AppServerCollabSpawnCachedHistory = "app_server_collab_spawn_cached_history";
	...
	public static function fromString(value:String):TuiSmokeToolLifecycleActionKind {
		return switch value {
			...
			case "app_server_collab_spawn_cached_history": AppServerCollabSpawnCachedHistory;
