...
typedef TuiSmokeSelectionTabsPlanFields = {
	...
	final actions:Array<TuiSmokeSelectionTabsAction>;
}

@:build(codexhx.macros.FieldRecordConstructor.build())
class TuiSmokeSelectionTabsPlan {
	...
	public final actions:Array<TuiSmokeSelectionTabsAction>;
