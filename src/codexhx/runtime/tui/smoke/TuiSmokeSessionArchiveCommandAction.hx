...
typedef TuiSmokeSessionArchiveCommandActionFields = {
	...
	final displayPreview:String;
	final path:String;
	final gitBranch:String;
	...
	final archivedMatchesFilter:Bool;
	final rowAccepted:Bool;
...
class TuiSmokeSessionArchiveCommandAction {
	...
	public final displayPreview:String;
	public final path:String;
	public final gitBranch:String;
	...
	public final archivedMatchesFilter:Bool;
	public final rowAccepted:Bool;
