...
typedef TuiSmokeStatusCardActionFields = {
	...
	final requestId:Int;
	final nextRequestId:Int;
	final pendingRefreshCount:Int;
	final remainingRefreshCount:Int;
	final snapshotPercentRemaining:Int;
	...
	final statusHistoryUpdated:Bool;
	final redrawRequested:Bool;
	final cachedForFutureStatus:Bool;
	final staleCompletionIgnored:Bool;
...
class TuiSmokeStatusCardAction {
	...
	public final nextRequestId:Int;
	public final pendingRefreshCount:Int;
	public final remainingRefreshCount:Int;
	public final snapshotPercentRemaining:Int;
	...
	public final statusHistoryUpdated:Bool;
	public final redrawRequested:Bool;
	public final cachedForFutureStatus:Bool;
	public final staleCompletionIgnored:Bool;
