...
typedef TuiSmokeChatWidgetInterruptedRestoreActionFields = {
	...
	final retryStatusHeaderAfter:String;
	final restoredStatusHeader:String;
	final retryDetails:String;
	...
	final retryStatusRemembered:Bool;
	final retryStatusTaken:Bool;
	final statusIndicatorVisible:Bool;
	final retryStatusShown:Bool;
	final retryStatusRestored:Bool;
...
class TuiSmokeChatWidgetInterruptedRestoreAction {
	...
	public final retryStatusHeaderAfter:String;
	public final restoredStatusHeader:String;
	public final retryDetails:String;
	...
	public final retryStatusRemembered:Bool;
	public final retryStatusTaken:Bool;
	public final statusIndicatorVisible:Bool;
	public final retryStatusShown:Bool;
	public final retryStatusRestored:Bool;
