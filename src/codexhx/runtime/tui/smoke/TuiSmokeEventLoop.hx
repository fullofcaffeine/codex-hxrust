		...
		for (action in plan.actions) {
			switch action.kind {
				...
				case TuiSmokeSessionArchiveCommandActionKind.ThreadListRequest:
					trace.push(
						"tui.session_archive_command.thread_list_request="
						+ "id=" + action.requestId
						...
						+ ":state_db_only=" + action.useStateDbOnly
						+ ":search=" + action.target
					);
				case TuiSmokeSessionArchiveCommandActionKind.ThreadListResponse:
					trace.push(
						"tui.session_archive_command.thread_list_response="
						+ "id=" + action.requestId
						+ ":method=" + action.method
						+ ":rows=" + action.rowCount
						+ ":next=" + action.nextCursor
		...
		for (action in plan.actions) {
			switch action.kind {
				...
				case TuiSmokeResumeForkActionKind.PickerPreviewToggle:
					trace.push(
						"tui.resume_fork.picker_preview_toggle="
						+ "selected=" + action.selectedIndex
						+ ":thread=" + action.threadId
						+ ":expanded=" + action.expandedThreadId
						+ ":cache=" + action.previewCacheBefore + "->" + action.previewCacheAfter
						+ ":inserted=" + action.cacheInserted
						+ ":toggled=" + action.expansionToggled
						+ ":frame=" + action.frameScheduled
					);
				case TuiSmokeResumeForkActionKind.PickerPreviewRequest:
					trace.push(
						"tui.resume_fork.picker_preview_request="
						+ "thread=" + action.threadId
				...
				case TuiSmokeResumeForkActionKind.PickerPreviewComplete:
					trace.push(
						"tui.resume_fork.picker_preview_complete="
						+ "thread=" + action.threadId
				...
				case TuiSmokeResumeForkActionKind.PickerPreviewRender:
					trace.push(
						"tui.resume_fork.picker_preview_render="
						+ "thread=" + action.threadId
						+ ":expanded=" + action.expandedThreadId
						+ ":state=" + action.previewState
						+ ":selected=" + action.selected
						+ ":rendered=" + action.previewRendered
						+ ":lines=" + action.previewLineCount
						+ ":no_render=" + action.noRatatuiRender
					);
		...
		for (action in plan.actions) {
			switch action.kind {
				case TuiSmokeStatusSurfaceRenderActionKind.SelectItems:
					trace.push(
						"tui.chat_widget_status_surface_render.select="
						+ "surface=" + action.surface
						+ ":items=" + action.itemIds
						+ ":count=" + action.itemCount
						+ ":visible=" + action.visibleCount
						+ ":status_line=" + action.statusLineEnabled
						+ ":title=" + action.terminalTitleEnabled
					);
				case TuiSmokeStatusSurfaceRenderActionKind.Indicator:
					trace.push(
						"tui.chat_widget_status_surface_render.indicator="
						+ action.indicator
						+ ":model=" + action.model
						+ ":branch=" + action.branch
						+ ":git=" + action.gitSummary
						+ ":raw=" + action.rawOutputLabel
						+ ":model_visible=" + action.modelVisible
						+ ":branch_visible=" + action.branchVisible
						+ ":git_visible=" + action.gitSummaryVisible
						+ ":raw_visible=" + action.rawOutputVisible
						+ ":activity_visible=" + action.activityVisible
						+ ":segments=" + action.segmentCount
						+ ":branch_request=" + action.branchRequested
						+ ":git_request=" + action.gitSummaryRequested
						+ ":hyperlink=" + action.hyperlinkAnnotated
					);
				case TuiSmokeStatusSurfaceRenderActionKind.Warning:
					trace.push(
						"tui.chat_widget_status_surface_render.warning="
						+ action.warningCode
						+ ":message=" + action.warningMessage
						+ ":visible=" + action.warningsVisible
						+ ":deduped=" + action.warningDeduped
						+ ":count=" + action.warningCount
						+ ":dedupe_count=" + action.dedupeCount
					);
				case TuiSmokeStatusSurfaceRenderActionKind.Preview:
					trace.push(
						"tui.chat_widget_status_surface_render.preview="
						+ action.surface
						+ ":items=" + action.previewItems
						+ ":started=" + action.previewStarted
						+ ":committed=" + action.previewCommitted
						+ ":reverted=" + action.previewReverted
					);
				case TuiSmokeStatusSurfaceRenderActionKind.Refresh:
					trace.push(
						"tui.chat_widget_status_surface_render.refresh="
						+ "run=" + action.runState
						+ ":header=" + action.statusHeader
						+ ":details=" + action.statusDetails
						+ ":text=" + action.renderedText
				...
				case TuiSmokeStatusSurfaceRenderActionKind.Failure:
					trace.push(
						"tui.chat_widget_status_surface_render.failure="
						+ action.failureCode
						+ ":no_render=" + action.noRatatuiRender
						+ ":no_model=" + action.noModelCall
						+ ":no_app_server=" + action.noAppServerMutation
		...
		for (action in plan.actions) {
			switch action.kind {
				case TuiSmokeSessionFlowActionKind.ConfigureSession:
					trace.push(
						"tui.chat_widget_session_flow.configure="
						+ action.display
						+ ":thread=" + action.previousThreadId + "->" + action.threadId
						+ ":name=" + action.threadName
						+ ":history=" + action.logId + "/" + action.historyEntryCount
						+ ":copy_reset=" + action.copyHistoryReset
						+ ":queue_clear=" + action.queueSubmissionsCleared
						+ ":review_reset=" + action.reviewDenialsReset
						+ ":turn_reset=" + action.turnLifecycleReset
						+ ":goal_clear=" + action.goalStatusCleared
						+ ":cwd=" + action.cwd
						+ ":roots=" + action.workspaceRoots
						+ ":approval=" + action.approvalPolicy
						+ ":permission=" + action.activePermissionProfile
						+ ":fallback=" + action.permissionFallbackApplied
						+ ":model=" + action.model
						+ ":effort=" + action.reasoningEffort
						+ ":collab=" + action.collaborationMode
						+ ":mask=" + action.collaborationMaskInitialized
						+ ":effective=" + action.effectiveCollaborationSet
					);
				case TuiSmokeSessionFlowActionKind.SessionHeader:
					trace.push(
						"tui.chat_widget_session_flow.header="
						+ action.display
						+ ":inserted=" + action.sessionInfoInserted
						+ ":cleared=" + action.activeSessionHeaderCleared
						+ ":revision=" + action.activeCellRevisionBumped
						+ ":service=" + action.serviceTier
						+ ":copy_source_reset=" + action.copySourceReset
						+ ":redraw=" + action.requestRedraw
						+ ":suppress=" + action.suppressRedraw
					);
				case TuiSmokeSessionFlowActionKind.SkillsConnectors:
					trace.push(
						"tui.chat_widget_session_flow.skills_connectors="
						+ "cleared=" + action.skillsCleared
						+ ":reload=" + action.skillsReloadRequested
						+ ":skills=" + action.skillsCount
						+ ":connectors=" + action.connectorCount
						+ ":prefetch=" + action.connectorsPrefetched
						+ ":service_cmd=" + action.serviceTierCommandsSynced
						+ ":personality_cmd=" + action.personalityCommandSynced
						+ ":plugins_cmd=" + action.pluginsCommandSynced
						+ ":goal_cmd=" + action.goalCommandSynced
						+ ":plugin_mentions=" + action.pluginMentionsRefreshed
					);
				case TuiSmokeSessionFlowActionKind.InitialUserMessage:
					trace.push(
						"tui.chat_widget_session_flow.initial_message="
						+ action.initialMessage
						+ ":submitted=" + action.initialMessageSubmitted
						+ ":suppressed=" + action.initialMessageSuppressed
						+ ":sandbox_blocked=" + action.elevatedSandboxBlocked
				...
				case TuiSmokeSessionFlowActionKind.ForkedThreadEvent:
					trace.push(
						"tui.chat_widget_session_flow.fork_notice="
						+ action.forkedFromId
						+ ":title=" + action.forkParentTitle
						+ ":inserted=" + action.forkNoticeInserted
						+ ":display=" + action.display
					);
				case TuiSmokeSessionFlowActionKind.ThreadNameUpdated:
					trace.push(
						"tui.chat_widget_session_flow.thread_name="
						+ action.threadId
						+ ":matched=" + action.threadMatched
						+ ":name=" + action.threadName
						+ ":confirm=" + action.renameConfirmationInserted
						+ ":surfaces=" + action.statusSurfacesRefreshed
						+ ":redraw=" + action.requestRedraw
						+ ":drain=" + action.queuedInputDrainAttempted
					);
				case TuiSmokeSessionFlowActionKind.Failure:
					trace.push(
						"tui.chat_widget_session_flow.failure="
						+ action.failureCode
						+ ":error=" + action.errorMessage
						+ ":no_fs=" + action.noFilesystemMutation
						+ ":no_network=" + action.noNetwork
