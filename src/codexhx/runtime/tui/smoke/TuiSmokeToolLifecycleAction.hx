...
typedef TuiSmokeToolLifecycleActionFields = {
	...
	final receiverThreadIds:String;
	final receiverLabels:String;
	final receiverStatuses:String;
	final receiverMessages:String;
	final requestedModel:String;
	final requestedReasoningEffort:String;
	final threadId:String;
	final summary:String;
	final failureCode:String;
	final changeCount:Int;
	final historyCellCount:Int;
	final receiverCount:Int;
	final completedReceiverCount:Int;
	final runningReceiverCount:Int;
	final exitCode:Int;
	...
	final receiverMetadataPreserved:Bool;
...
class TuiSmokeToolLifecycleAction {
	...
	public final receiverThreadIds:String;
	public final receiverLabels:String;
	public final receiverStatuses:String;
	public final receiverMessages:String;
	public final requestedModel:String;
	public final requestedReasoningEffort:String;
	public final threadId:String;
	public final summary:String;
	public final failureCode:String;
	public final changeCount:Int;
	public final historyCellCount:Int;
	public final receiverCount:Int;
	public final completedReceiverCount:Int;
	public final runningReceiverCount:Int;
	...
	public final receiverMetadataPreserved:Bool;
