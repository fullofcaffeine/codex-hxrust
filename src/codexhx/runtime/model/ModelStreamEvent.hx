...
class ModelStreamEvent {
	...
	public function canonicalJson():String {
		return "{" + "\"errorCode\":" + JsonScalar.quote(errorCode) + ",\"errorMessage\":" + JsonScalar.quote(errorMessage) + ",\"itemId\":"
			+ JsonScalar.quote(itemId) + ",\"kind\":" + JsonScalar.quote(kind) + ",\"responseId\":" + JsonScalar.quote(responseId) + ",\"text\":"
			+ JsonScalar.quote(text) + ",\"totalTokens\":" + Std.string(totalTokens) + "}";
	}
}
