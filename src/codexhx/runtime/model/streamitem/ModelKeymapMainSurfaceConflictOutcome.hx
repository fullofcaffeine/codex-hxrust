...
class ModelKeymapMainSurfaceConflictOutcome {
	...
	public function summary():String {
		return "code=" + code
			...
			+ ";configuredToggleFastModeBindingPreserved=" + boolText(configuredToggleFastModeBindingPreserved)
			+ ";defaultClearTerminalBindingPreserved=" + boolText(defaultClearTerminalBindingPreserved)
