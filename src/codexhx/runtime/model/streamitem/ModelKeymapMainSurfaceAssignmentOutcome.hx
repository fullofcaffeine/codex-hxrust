...
typedef ModelKeymapMainSurfaceAssignmentOutcomeFields = {
	final ok:Bool;
	final code:String;
	final requestId:String;
	final decisionKind:ModelKeymapMainSurfaceAssignmentDecisionKind;
...
class ModelKeymapMainSurfaceAssignmentOutcome {
	public final ok:Bool;
	public final code:String;
	public final requestId:String;
	public final decisionKind:ModelKeymapMainSurfaceAssignmentDecisionKind;
	...
	public function new(fields:ModelKeymapMainSurfaceAssignmentOutcomeFields) {
		this.ok = fields.ok;
		this.code = fields.code == null ? "" : fields.code;
		this.requestId = fields.requestId == null ? "" : fields.requestId;
		this.decisionKind = fields.decisionKind == null ? ModelKeymapMainSurfaceAssignmentDecisionKind.KeymapMainSurfaceAssignmentRejected : fields.decisionKind;
