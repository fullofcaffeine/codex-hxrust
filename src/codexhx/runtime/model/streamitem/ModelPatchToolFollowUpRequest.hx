...
class ModelPatchToolFollowUpRequest {
	...
	public function new(requestId:String, reducerOutcome:ModelStreamItemReducerOutcome, applicationOutcome:ModelPatchApplicationOutcome,
			projectionOutcome:ModelPatchProjectionOutcome, secretProbe:String) {
