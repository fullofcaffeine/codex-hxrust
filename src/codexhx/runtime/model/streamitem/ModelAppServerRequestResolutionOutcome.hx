...
class ModelAppServerRequestResolutionOutcome {
	...
	public function new(ok:Bool, code:String, requestId:String, surfaceRequestId:String, requestKind:ModelReplayedServerRequestKind,
			commandKind:ModelAppServerRequestResolutionCommandKind, payloadKind:ModelAppServerRequestResolutionPayloadKind, appServerRequestId:String,
			requestKey:String, commandKey:String, pendingRequestRecorded:Bool, commandMatchedPendingRequest:Bool, requestRemovedFromPending:Bool,
			serializedResponseIntentEmitted:Bool, execApprovalResolved:Bool, fileChangeApprovalResolved:Bool, permissionsResolved:Bool,
			userInputQueuePopped:Bool, userInputQueueLengthAfter:Int, resolvedUserInputItemId:String, mcpElicitationResolved:Bool,
			requestRemovedByNotification:Bool, duplicateOrMissingNoop:Bool, unsupportedRequestRejected:Bool, liveAppServerFanoutSuppressed:Bool,
	...
	public function summary():String {
		return "code=" + code + ";ok=" + boolText(ok) + ";request=" + requestId + ";surfaceRequest=" + noneIfEmpty(surfaceRequestId) + ";requestKind="
			+ requestKind + ";commandKind=" + commandKind + ";payloadKind=" + payloadKind + ";appServerRequestId=" + noneIfEmpty(appServerRequestId)
			+ ";requestKey=" + noneIfEmpty(requestKey) + ";commandKey=" + noneIfEmpty(commandKey) + ";pendingRequestRecorded="
			+ boolText(pendingRequestRecorded) + ";commandMatchedPendingRequest=" + boolText(commandMatchedPendingRequest) + ";requestRemovedFromPending="
			+ boolText(requestRemovedFromPending) + ";serializedResponseIntentEmitted=" + boolText(serializedResponseIntentEmitted)
			+ ";execApprovalResolved=" + boolText(execApprovalResolved) + ";fileChangeApprovalResolved=" + boolText(fileChangeApprovalResolved)
			+ ";permissionsResolved=" + boolText(permissionsResolved) + ";userInputQueuePopped=" + boolText(userInputQueuePopped)
			+ ";userInputQueueLengthAfter=" + userInputQueueLengthAfter + ";resolvedUserInputItemId=" + noneIfEmpty(resolvedUserInputItemId)
			+ ";mcpElicitationResolved=" + boolText(mcpElicitationResolved) + ";requestRemovedByNotification=" + boolText(requestRemovedByNotification)
			+ ";duplicateOrMissingNoop=" + boolText(duplicateOrMissingNoop) + ";unsupportedRequestRejected=" + boolText(unsupportedRequestRejected)
			+ ";liveAppServerFanoutSuppressed=" + boolText(liveAppServerFanoutSuppressed) + ";liveNetworkAttempted=" + boolText(liveNetworkAttempted)
