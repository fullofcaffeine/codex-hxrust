...
typedef ModelKeymapComposerFixedShortcutConflictOutcomeFields = {
	final ok:Bool;
	final code:String;
	final requestId:String;
	final decisionKind:ModelKeymapComposerFixedShortcutConflictDecisionKind;
	final configuredComposerSubmitBindingPreserved:Bool;
	final fixedPasteImageBindingPreserved:Bool;
...
class ModelKeymapComposerFixedShortcutConflictOutcome {
	public final ok:Bool;
	public final code:String;
	public final requestId:String;
	public final decisionKind:ModelKeymapComposerFixedShortcutConflictDecisionKind;
	public final configuredComposerSubmitBindingPreserved:Bool;
	public final fixedPasteImageBindingPreserved:Bool;
	...
	public function new(fields:ModelKeymapComposerFixedShortcutConflictOutcomeFields) {
		this.ok = fields.ok;
		this.code = fields.code == null ? "" : fields.code;
		this.requestId = fields.requestId == null ? "" : fields.requestId;
		this.decisionKind = fields.decisionKind == null ? ModelKeymapComposerFixedShortcutConflictDecisionKind.KeymapComposerFixedShortcutConflictMissed : fields.decisionKind;
		this.configuredComposerSubmitBindingPreserved = fields.configuredComposerSubmitBindingPreserved;
		this.fixedPasteImageBindingPreserved = fields.fixedPasteImageBindingPreserved;
	...
	public function summary():String {
		return "code=" + code + ";ok=" + boolText(ok) + ";request=" + requestId + ";decisionKind=" + decisionKind
			+ ";configuredComposerSubmitBindingPreserved=" + boolText(configuredComposerSubmitBindingPreserved) + ";fixedPasteImageBindingPreserved="
			+ boolText(fixedPasteImageBindingPreserved) + ";conflictActionNamesPreserved=" + boolText(conflictActionNamesPreserved)
