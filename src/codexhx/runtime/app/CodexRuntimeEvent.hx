...
class CodexRuntimeEvent {
	...
	function new(sequence:Int, kind:CodexRuntimeEventKind, delivery:CodexRuntimeEventDelivery, method:String, requestId:String, payloadJson:String,
			summary:String, skipped:Int) {
	...
	public static function notification(sequence:Int, method:String, payloadJson:String, summary:String):CodexRuntimeEvent {
		return new CodexRuntimeEvent(sequence, CodexRuntimeEventKind.ServerNotification, CodexRuntimeNotificationDelivery.classify(method), method, "",
			payloadJson, summary, 0);
	}

	public static function response(sequence:Int, requestId:String, method:String, payloadJson:String):CodexRuntimeEvent {
		return new CodexRuntimeEvent(sequence, CodexRuntimeEventKind.ClientResponse, CodexRuntimeEventDelivery.Control, method, requestId, payloadJson,
			"response:" + method, 0);
	}
	...
	public static function error(sequence:Int, requestId:String, method:String, payloadJson:String, summary:String):CodexRuntimeEvent {
		return new CodexRuntimeEvent(sequence, CodexRuntimeEventKind.ClientError, CodexRuntimeEventDelivery.Control, method, requestId, payloadJson, summary,
			0);
	}

	public static function lagged(sequence:Int, skipped:Int):CodexRuntimeEvent {
		return new CodexRuntimeEvent(sequence, CodexRuntimeEventKind.Lagged, CodexRuntimeEventDelivery.BestEffort, "", "",
			"{\"skipped\":"
			+ Std.string(skipped)
			+ "}", "lagged:"
	...
	public static function disconnected(sequence:Int, message:String):CodexRuntimeEvent {
		return new CodexRuntimeEvent(sequence, CodexRuntimeEventKind.Disconnected, CodexRuntimeEventDelivery.Control, "", "",
			"{\"message\":" + quote(message) + "}", "disconnected", 0);
	}
