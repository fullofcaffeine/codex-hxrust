...
class ThreadReadActiveGoalProgressAccountingOutcome {
	...
	public static function missingSnapshot(turnId:String):ThreadReadActiveGoalProgressAccountingOutcome {
		return new ThreadReadActiveGoalProgressAccountingOutcome(
			true,
			...
			false,
			false,
			"account_active_goal_progress:" + turnId + "->progress_snapshot/none->return_none",
	...
	public static function stateError(kind:String, code:String):ThreadReadActiveGoalProgressAccountingOutcome {
		return new ThreadReadActiveGoalProgressAccountingOutcome(
			...
			false,
			false,
			"account_active_goal_progress->progress_snapshot->account_thread_goal_usage/error:" + code,
	...
	public static function updated(
		...
		terminalMetricRecorded:Bool,
		disposition:String
	):ThreadReadActiveGoalProgressAccountingOutcome {
		return new ThreadReadActiveGoalProgressAccountingOutcome(
			true,
			code,
			true,
			...
			"account_active_goal_progress->progress_snapshot:" + goalId
				+ "->account_thread_goal_usage/updated"
				+ "->mark_progress_accounted_for_status:" + status + "/" + disposition
				+ "->thread_goal_updated",
	...
	public function summary():String {
		return "ok=" + (ok ? "true" : "false")
			+ ";code=" + code
			+ ";snapshot=" + (progressSnapshotAvailable ? "true" : "false")
			...
			+ ";goalId=" + goalId
			+ ";status=" + status
			+ ";usageMarked=" + (turnLastUsageUpdated ? "true" : "false")
