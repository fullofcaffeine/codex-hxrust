...
class ThreadReadResumeGoalSnapshotOutcome {
	...
	function new(
		...
		continuationIntent:ThreadReadResumeGoalContinuationIntent,
		pendingRequestsReplayPoint:String,
		message:String
	) {
		this.ok = ok;
		this.code = code;
	...
	public static function updated(
		...
		return new ThreadReadResumeGoalSnapshotOutcome(
			true,
			"goal_snapshot_updated",
			operation,
			true,
			true,
			false,
	...
	public static function cleared(
		...
		return new ThreadReadResumeGoalSnapshotOutcome(
			...
			sequence,
			"thread/goal/cleared",
			ThreadReadResumeGoalContinuationIntent.None,
			pendingRequestsReplayPoint,
	...
	public function summary():String {
		return "operation=" + operation
			+ ";ok=" + (ok ? "true" : "false")
			+ ";code=" + code
			+ ";snapshotDelivered=" + (snapshotDelivered ? "true" : "false")
			+ ";goalUpdated=" + (goalUpdated ? "true" : "false")
			+ ";goalCleared=" + (goalCleared ? "true" : "false")
			+ ";skipped=" + (skipped ? "true" : "false")
			+ ";notification=" + notificationMethod
			+ ";sequence=" + sequence
			+ ";pendingRequestsReplayPoint=" + pendingRequestsReplayPoint
