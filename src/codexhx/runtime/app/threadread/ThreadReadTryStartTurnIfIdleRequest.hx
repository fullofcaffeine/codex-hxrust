...
class ThreadReadTryStartTurnIfIdleRequest {
	...
	public function new(
		...
		inputEmpty:Bool,
		pendingTriggerTurnBeforeReservation:Bool,
		collaborationPlanModeBeforeReservation:Bool,
		activeTaskKind:ThreadReadTryStartTurnIfIdleActiveTaskKind,
		pendingTriggerTurnAfterReservation:Bool,
		collaborationPlanModeAfterTurnContext:Bool,
		pendingTriggerTurnAfterTurnContext:Bool,
		reservationLostBeforeStart:Bool
	) {
