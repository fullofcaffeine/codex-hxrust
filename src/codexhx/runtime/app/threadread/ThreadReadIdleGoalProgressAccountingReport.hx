...
class ThreadReadIdleGoalProgressAccountingReport {
	public final schema:String;
	public final outcomes:Array<ThreadReadIdleGoalProgressAccountingOutcome>;

	public function new(outcomes:Array<ThreadReadIdleGoalProgressAccountingOutcome>) {
		this.schema = "codex-hxrust.thread-read-idle-goal-progress-accounting-report.v1";
