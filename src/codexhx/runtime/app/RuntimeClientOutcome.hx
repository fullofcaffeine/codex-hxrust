...
class RuntimeClientOutcome {
	...
	function new(ok:Bool, code:String, message:String, requestId:String, method:String, canonicalJson:String, queue:Null<RuntimeQueuePushOutcome>,
			pendingCount:Int) {
		this.ok = ok;
		this.code = code;
	...
	public static function evented(code:String, requestId:String, method:String, canonicalJson:String, queue:RuntimeQueuePushOutcome,
			pendingCount:Int):RuntimeClientOutcome {
