...
- Notifications: `thread/started`, `thread/status/changed`, `turn/started`, `turn/completed`, `item/started`, `item/agentMessage/delta`, `item/completed`, `rawResponseItem/completed`, and `error`.
