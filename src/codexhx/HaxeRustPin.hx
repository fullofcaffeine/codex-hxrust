...
class HaxeRustPin {
	public static inline final schema:String = "codex-hxrust.reference-pin.v1";
	...
	public static inline final commit:String = "5fdc545bfc44b9e50a2c5dcf2249ac5f5f95f5db";
	...
	public static inline final localPatches:String = "reference/haxe-rust-local-patches.v1.json";
}
