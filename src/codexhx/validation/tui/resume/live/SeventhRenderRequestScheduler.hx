...
class SeventhRenderRequestScheduler {
	...
	public function schedule(report:SeventhInputRenderIntentReport, scheduler:DeterministicFrameScheduler):CompletionRenderRequestSchedule {
