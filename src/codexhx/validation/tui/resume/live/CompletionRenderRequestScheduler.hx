...
class CompletionRenderRequestScheduler {
	...
	public function schedule(report:CompletionInputRenderIntentReport, scheduler:DeterministicFrameScheduler):CompletionRenderRequestSchedule {
