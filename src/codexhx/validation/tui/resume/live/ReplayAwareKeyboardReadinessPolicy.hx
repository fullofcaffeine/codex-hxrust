...
class ReplayAwareKeyboardReadinessPolicy {
	...
	public function admit(report:PostRenderStateHandoffReport, intents:Array<RecoveryKeyboardIntentKind>):RecoveryReplayAwareKeyboardReadiness {
	...
	function sourceReady(report:PostRenderStateHandoffReport):Bool {
	...
	function decide(report:PostRenderStateHandoffReport, intent:RecoveryKeyboardIntentKind, ready:Bool):RecoveryKeyboardDecision {
