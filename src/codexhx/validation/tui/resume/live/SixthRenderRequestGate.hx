...
class SixthRenderRequestGate {
	public static function run():SixthRenderRequestReport {
		final renderIntentReport = SixthInputRenderIntentGate.run();
		final frameScheduler = new DeterministicFrameScheduler();
		final requestScheduler = new SixthRenderRequestScheduler();
		final schedule = requestScheduler.schedule(renderIntentReport, frameScheduler);
		return new SixthRenderRequestReport({
