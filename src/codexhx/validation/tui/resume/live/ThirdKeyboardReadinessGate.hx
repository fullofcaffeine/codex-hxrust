...
class ThirdKeyboardReadinessGate {
	public static function run():ThirdKeyboardReadinessReport {
		final handoffReport = SecondExecutionHandoffGate.run();
		final policy = new ThirdKeyboardReadinessPolicy();
		final readiness = policy.admit(handoffReport, [RecoveryKeyboardIntentKind.MoveDown, RecoveryKeyboardIntentKind.MoveUp]);
		return new ThirdKeyboardReadinessReport({
