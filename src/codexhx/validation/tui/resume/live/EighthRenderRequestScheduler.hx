...
class EighthRenderRequestScheduler {
	...
	public function schedule(report:EighthInputRenderIntentReport, scheduler:DeterministicFrameScheduler):CompletionRenderRequestSchedule {
