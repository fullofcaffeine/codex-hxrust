...
class FifthKeyboardReadinessPolicy {
	...
	public function admit(report:FourthExecutionHandoffReport, intents:Array<RecoveryKeyboardIntentKind>):RecoveryReplayAwareKeyboardReadiness {
	...
	function sourceReady(report:FourthExecutionHandoffReport):Bool {
	...
	function decide(report:FourthExecutionHandoffReport, intent:RecoveryKeyboardIntentKind, ready:Bool):RecoveryKeyboardDecision {
