...
class SixthInputAdmissionGate {
	public static function run():SixthInputAdmissionReport {
		final completionReport = SixthCompletionHandoffGate.run();
		final policy = new SixthInputAdmissionPolicy();
		final admission = policy.admit(completionReport, CompletionInputIntentKind.ConfirmRecoveredSelection);
		return new SixthInputAdmissionReport({
