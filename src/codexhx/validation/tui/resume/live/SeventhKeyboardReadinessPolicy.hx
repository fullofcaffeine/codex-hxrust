...
class SeventhKeyboardReadinessPolicy {
	...
	public function admit(report:SixthExecutionHandoffReport, intents:Array<RecoveryKeyboardIntentKind>):RecoveryReplayAwareKeyboardReadiness {
	...
	function sourceReady(report:SixthExecutionHandoffReport):Bool {
	...
	function decide(report:SixthExecutionHandoffReport, intent:RecoveryKeyboardIntentKind, ready:Bool):RecoveryKeyboardDecision {
	...
	function compactSummary(readiness:RecoveryReplayAwareKeyboardReadiness):String {
