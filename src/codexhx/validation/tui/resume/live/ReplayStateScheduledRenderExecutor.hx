...
class ReplayStateScheduledRenderExecutor {
	...
	public function execute(report:ReplayStateRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
	...
	function executeReady(report:ReplayStateRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
	...
	function rejected(report:ReplayStateRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
		return new CompletionScheduledRenderExecution({
