...
class FourthCompletionHandoffGate {
	public static function run():FourthCompletionHandoffReport {
		final replayReport = FourthSnapshotReplayGate.run();
		final policy = new FourthCompletionHandoffPolicy();
		final handoff = policy.handoff(replayReport);
		return new FourthCompletionHandoffReport({
