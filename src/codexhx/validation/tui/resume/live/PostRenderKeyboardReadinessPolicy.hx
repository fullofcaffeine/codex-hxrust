...
import codexhx.runtime.tui.resume.host.PostRenderKeyboardReadiness;
...
class PostRenderKeyboardReadinessPolicy {
	...
	public function admit(report:CompletionStateHandoffReport, intents:Array<RecoveryKeyboardIntentKind>):PostRenderKeyboardReadiness {
		...
		final out = new PostRenderKeyboardReadiness({
	...
	function sourceReady(report:CompletionStateHandoffReport):Bool {
	...
	function decide(report:CompletionStateHandoffReport, intent:RecoveryKeyboardIntentKind, ready:Bool):RecoveryKeyboardDecision {
