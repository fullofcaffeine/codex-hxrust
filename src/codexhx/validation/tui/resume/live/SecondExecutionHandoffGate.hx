...
class SecondExecutionHandoffGate {
	public static function run():SecondExecutionHandoffReport {
		final executionReport = SecondScheduledRenderGate.run();
		final policy = new SecondExecutionHandoffPolicy();
		final handoff = policy.handoff(executionReport);
		return new SecondExecutionHandoffReport({
