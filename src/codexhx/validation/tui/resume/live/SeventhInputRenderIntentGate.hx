...
class SeventhInputRenderIntentGate {
	public static function run():SeventhInputRenderIntentReport {
		final admissionReport = SeventhInputAdmissionGate.run();
		final planner = new SeventhInputRenderIntentPlanner();
		final intent = planner.plan(admissionReport);
		return new SeventhInputRenderIntentReport({
