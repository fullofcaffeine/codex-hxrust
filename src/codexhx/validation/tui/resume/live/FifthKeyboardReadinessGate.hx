...
class FifthKeyboardReadinessGate {
	public static function run():FifthKeyboardReadinessReport {
		final handoffReport = FourthExecutionHandoffGate.run();
		final policy = new FifthKeyboardReadinessPolicy();
		final readiness = policy.admit(handoffReport, [RecoveryKeyboardIntentKind.MoveDown, RecoveryKeyboardIntentKind.MoveUp]);
		return new FifthKeyboardReadinessReport({
