...
class FifthScheduledRenderGate {
	public static function run():FifthScheduledRenderReport {
		final schedulingReport = FifthRenderRequestGate.run();
		final renderer = new DeterministicTerminalRenderer();
		final executor = new FifthScheduledRenderExecutor();
		final execution = executor.execute(schedulingReport, renderer);
		return new FifthScheduledRenderReport({
