...
class ThirdRenderRequestGate {
	public static function run():ThirdRenderRequestReport {
		final renderIntentReport = ThirdInputRenderIntentGate.run();
		final frameScheduler = new DeterministicFrameScheduler();
		final requestScheduler = new ThirdRenderRequestScheduler();
		final schedule = requestScheduler.schedule(renderIntentReport, frameScheduler);
		return new ThirdRenderRequestReport({
