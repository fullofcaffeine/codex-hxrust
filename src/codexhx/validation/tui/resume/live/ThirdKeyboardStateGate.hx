...
class ThirdKeyboardStateGate {
	static final FinalFooter = "footer keyboard move_up selected=0 selectedThread=thread-surface-a";

	public static function run():ThirdKeyboardStateReport {
		final readinessReport = ThirdKeyboardReadinessGate.run();
		...
		return new ThirdKeyboardStateReport({
	...
	static function decisionsFrom(readinessReport:ThirdKeyboardReadinessReport):Array<RecoveryKeyboardDecision> {
	...
	static function decision(ready:Bool, intent:RecoveryKeyboardIntentKind, sequence:Int, selectedBefore:Int, selectedAfter:Int, threadBefore:String,
			threadAfter:String, rejectedThreadAfter:String, readinessReport:ThirdKeyboardReadinessReport):RecoveryKeyboardDecision {
