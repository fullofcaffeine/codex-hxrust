...
class SeventhInputAdmissionPolicy {
	...
	public function admit(report:SeventhCompletionHandoffReport, intent:CompletionInputIntentKind):CompletionInputAdmission {
