...
class ReplayAwareRenderRequestScheduler {
	...
	public function schedule(report:ReplayAwareInputRenderIntentReport, scheduler:DeterministicFrameScheduler):CompletionRenderRequestSchedule {
