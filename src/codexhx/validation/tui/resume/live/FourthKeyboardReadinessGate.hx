...
class FourthKeyboardReadinessGate {
	public static function run():FourthKeyboardReadinessReport {
		final handoffReport = ThirdExecutionHandoffGate.run();
		final policy = new FourthKeyboardReadinessPolicy();
		final readiness = policy.admit(handoffReport, [RecoveryKeyboardIntentKind.MoveDown, RecoveryKeyboardIntentKind.MoveUp]);
		return new FourthKeyboardReadinessReport({
