...
class ThirdScheduledRenderExecutor {
	...
	public function execute(report:ThirdRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
	...
	function executeReady(report:ThirdRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
	...
	function rejected(report:ThirdRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
		return new CompletionScheduledRenderExecution({
