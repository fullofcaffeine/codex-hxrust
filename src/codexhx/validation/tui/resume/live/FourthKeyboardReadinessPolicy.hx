...
class FourthKeyboardReadinessPolicy {
	...
	public function admit(report:ThirdExecutionHandoffReport, intents:Array<RecoveryKeyboardIntentKind>):RecoveryReplayAwareKeyboardReadiness {
	...
	function sourceReady(report:ThirdExecutionHandoffReport):Bool {
	...
	function decide(report:ThirdExecutionHandoffReport, intent:RecoveryKeyboardIntentKind, ready:Bool):RecoveryKeyboardDecision {
