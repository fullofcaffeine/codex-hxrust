...
class AppServerBoundaryGate {
	public static function run():AppServerBoundaryReport {
		...
		return new AppServerBoundaryReport({
			requestIdsPreserved: allRequestIdsPreserved(requestSummaries, eventSummaries),
			requestFieldsPreserved: requestFieldsPreserved(requestSummaries),
	...
	static function requestFieldsPreserved(requestSummaries:Array<String>):Bool {
