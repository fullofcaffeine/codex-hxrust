...
class SeventhScheduledRenderGate {
	public static function run():SeventhScheduledRenderReport {
		final schedulingReport = SeventhRenderRequestGate.run();
		final renderer = new DeterministicTerminalRenderer();
		final executor = new SeventhScheduledRenderExecutor();
		final execution = executor.execute(schedulingReport, renderer);
		return new SeventhScheduledRenderReport({
