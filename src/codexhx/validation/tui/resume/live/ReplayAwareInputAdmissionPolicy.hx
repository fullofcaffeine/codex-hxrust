...
class ReplayAwareInputAdmissionPolicy {
	...
	public function admit(report:ReplayAwareCompletionHandoffReport, intent:CompletionInputIntentKind):CompletionInputAdmission {
