...
class PostRenderSnapshotReplayer {
	public function new() {}

	public function replay(report:PostRenderKeyboardStateReport):Array<RecoveryRenderSnapshotReplay> {
		return [
	...
	function entry(report:PostRenderKeyboardStateReport, replayIndex:Int, sourceSequence:Int, intent:RecoveryKeyboardIntentKind, selectedThreadId:String,
