...
class SeventhScheduledRenderExecutor {
	...
	public function execute(report:SeventhRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
	...
	function executeReady(report:SeventhRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
	...
	function rejected(report:SeventhRenderRequestReport, renderer:DeterministicTerminalRenderer):CompletionScheduledRenderExecution {
		return new CompletionScheduledRenderExecution({
