...
class FourthInputAdmissionGate {
	public static function run():FourthInputAdmissionReport {
		final completionReport = FourthCompletionHandoffGate.run();
		final policy = new FourthInputAdmissionPolicy();
		final admission = policy.admit(completionReport, CompletionInputIntentKind.ConfirmRecoveredSelection);
		return new FourthInputAdmissionReport({
