...
class ThirdKeyboardReadinessPolicy {
	...
	public function admit(report:SecondExecutionHandoffReport, intents:Array<RecoveryKeyboardIntentKind>):RecoveryReplayAwareKeyboardReadiness {
	...
	function sourceReady(report:SecondExecutionHandoffReport):Bool {
	...
	function decide(report:SecondExecutionHandoffReport, intent:RecoveryKeyboardIntentKind, ready:Bool):RecoveryKeyboardDecision {
