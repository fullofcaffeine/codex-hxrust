...
class EighthKeyboardReadinessPolicy {
	...
	public function admit(report:SeventhExecutionHandoffReport, intents:Array<RecoveryKeyboardIntentKind>):RecoveryReplayAwareKeyboardReadiness {
	...
	function sourceReady(report:SeventhExecutionHandoffReport):Bool {
	...
	function decide(report:SeventhExecutionHandoffReport, intent:RecoveryKeyboardIntentKind, ready:Bool):RecoveryKeyboardDecision {
