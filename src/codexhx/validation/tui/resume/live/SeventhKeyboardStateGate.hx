...
class SeventhKeyboardStateGate {
	static final FinalFooter = "footer keyboard move_up selected=0 selectedThread=thread-surface-a";

	public static function run():SeventhKeyboardStateReport {
		final readinessReport = SeventhKeyboardReadinessGate.run();
		...
		return new SeventhKeyboardStateReport({
	...
	static function decisionsFrom(readinessReport:SeventhKeyboardReadinessReport):Array<RecoveryKeyboardDecision> {
	...
	static function decision(ready:Bool, intent:RecoveryKeyboardIntentKind, sequence:Int, selectedBefore:Int, selectedAfter:Int, threadBefore:String,
			threadAfter:String, rejectedThreadAfter:String, readinessReport:SeventhKeyboardReadinessReport):RecoveryKeyboardDecision {
