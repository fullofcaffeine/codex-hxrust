...
class FourthInputRenderIntentGate {
	public static function run():FourthInputRenderIntentReport {
		final admissionReport = FourthInputAdmissionGate.run();
		final planner = new FourthInputRenderIntentPlanner();
		final intent = planner.plan(admissionReport);
		return new FourthInputRenderIntentReport({
