...
class SeventhExecutionHandoffGate {
	public static function run():SeventhExecutionHandoffReport {
		final executionReport = SeventhScheduledRenderGate.run();
		final policy = new SeventhExecutionHandoffPolicy();
		final handoff = policy.handoff(executionReport);
		return new SeventhExecutionHandoffReport({
