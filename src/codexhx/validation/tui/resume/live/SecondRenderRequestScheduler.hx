...
class SecondRenderRequestScheduler {
	...
	public function schedule(report:SecondInputRenderIntentReport, scheduler:DeterministicFrameScheduler):CompletionRenderRequestSchedule {
