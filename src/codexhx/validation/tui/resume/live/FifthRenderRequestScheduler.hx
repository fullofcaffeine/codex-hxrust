...
class FifthRenderRequestScheduler {
	...
	public function schedule(report:FifthInputRenderIntentReport, scheduler:DeterministicFrameScheduler):CompletionRenderRequestSchedule {
