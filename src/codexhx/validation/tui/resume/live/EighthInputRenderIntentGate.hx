...
class EighthInputRenderIntentGate {
	public static function run():EighthInputRenderIntentReport {
		final admissionReport = EighthInputAdmissionGate.run();
		final planner = new EighthInputRenderIntentPlanner();
		final intent = planner.plan(admissionReport);
		return new EighthInputRenderIntentReport({
