...
| `tui-smoke.hxml` | Compile the HXCX-TUI-0/HXCX-TUI-1/HXCX-TUI-2 generated TUI smoke binary, headless app-loop shell, and app-event queue facade through metal haxe.rust. |
