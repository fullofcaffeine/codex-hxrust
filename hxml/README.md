...
| `tui-smoke.hxml` | Compile the HXCX-TUI-0/HXCX-TUI-1/HXCX-TUI-2/HXCX-TUI-3 generated TUI smoke binary, headless app-loop shell, app-event queue facade, and app-server event facade through metal haxe.rust. |
