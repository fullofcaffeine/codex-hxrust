...
| `tui-smoke.hxml` | Compile the HXCX-TUI-0/HXCX-TUI-1/HXCX-TUI-2/HXCX-TUI-3/HXCX-TUI-4/HXCX-TUI-5/HXCX-TUI-6/HXCX-TUI-7/HXCX-TUI-8 generated TUI smoke binary, headless app-loop shell, app-event queue facade, app-server event facade, server-request facade, request-resolution facade, active-thread request delivery facade, active-thread notification delivery facade, and pending interactive replay-filter facade through metal haxe.rust. |
