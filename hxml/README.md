...
| `resume-picker-app-server-typed-response-recovery-post-completion-post-render-replay-aware-rendered-state-second-cycle-input-render-intent-render.hxml` | Compile the HXCX-TUI-189 resume picker normalized app-server typed response recovery post-completion post-render replay-aware rendered-state second-cycle input render-intent gate through portable haxe.rust. |
| `resume-picker-app-server-typed-response-recovery-post-completion-post-render-replay-aware-rendered-state-second-cycle-render-request-scheduling-render.hxml` | Compile the HXCX-TUI-190 resume picker normalized app-server typed response recovery post-completion post-render replay-aware rendered-state second-cycle render request scheduling gate through portable haxe.rust. |
| `resume-picker-app-server-typed-response-recovery-post-completion-post-render-replay-aware-rendered-state-second-cycle-scheduled-render-execution-render.hxml` | Compile the HXCX-TUI-191 resume picker normalized app-server typed response recovery post-completion post-render replay-aware rendered-state second-cycle scheduled render execution gate through portable haxe.rust. |
| `resume-picker-app-server-typed-response-recovery-post-completion-post-render-replay-aware-rendered-state-second-cycle-scheduled-execution-handoff-render.hxml` | Compile the HXCX-TUI-192 resume picker normalized app-server typed response recovery post-completion post-render replay-aware rendered-state second-cycle scheduled execution handoff gate through portable haxe.rust. |
| `resume-picker-app-server-typed-response-recovery-post-completion-post-render-replay-aware-rendered-state-third-cycle-keyboard-readiness-render.hxml` | Compile the HXCX-TUI-193 resume picker normalized app-server typed response recovery post-completion post-render replay-aware rendered-state third-cycle keyboard readiness gate through portable haxe.rust. |
| `resume-picker-app-server-typed-response-recovery-post-completion-post-render-replay-aware-rendered-state-third-cycle-keyboard-render-state-render.hxml` | Compile the HXCX-TUI-194 resume picker normalized app-server typed response recovery post-completion post-render replay-aware rendered-state third-cycle keyboard render-state gate through portable haxe.rust. |
| `resume-picker-app-server-typed-response-recovery-post-completion-post-render-replay-aware-rendered-state-third-cycle-keyboard-render-snapshot-replay-render.hxml` | Compile the HXCX-TUI-195 resume picker normalized app-server typed response recovery post-completion post-render replay-aware rendered-state third-cycle keyboard render-snapshot replay gate through portable haxe.rust. |
| `resume-picker-app-server-typed-response-recovery-post-completion-post-render-replay-aware-rendered-state-third-cycle-replay-completion-handoff-render.hxml` | Compile the HXCX-TUI-196 resume picker normalized app-server typed response recovery post-completion post-render replay-aware rendered-state third-cycle replay-completion handoff gate through portable haxe.rust. |
