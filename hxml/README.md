...
| `tui-smoke.hxml` | Compile the HXCX-TUI-0/HXCX-TUI-1/HXCX-TUI-2/HXCX-TUI-3/HXCX-TUI-4/HXCX-TUI-5 generated TUI smoke binary, headless app-loop shell, app-event queue facade, app-server event facade, server-request facade, and request-resolution facade through metal haxe.rust. |
