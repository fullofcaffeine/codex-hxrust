...
| `tui-smoke.hxml` | Compile the HXCX-TUI-0/HXCX-TUI-1/HXCX-TUI-2/HXCX-TUI-3/HXCX-TUI-4 generated TUI smoke binary, headless app-loop shell, app-event queue facade, app-server event facade, and server-request facade through metal haxe.rust. |
