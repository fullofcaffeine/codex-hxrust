...
| `model-stream-item-reducer.hxml` | Compile the HXCX-4.48/HXCX-4.50 raw stream item reducer, assistant output routing, and tool-call input delta harness through portable haxe.rust. |
