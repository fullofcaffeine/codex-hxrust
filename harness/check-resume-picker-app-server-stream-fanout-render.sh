...
cargo run --manifest-path generated/resume-picker-app-server-stream-fanout-render/Cargo.toml --locked --quiet

echo "Resume picker app-server stream fanout render harness passed."
