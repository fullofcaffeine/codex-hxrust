...
selected_schemas=(
  ...
  "AppsListParams:v2/AppsListParams.json"
  "AppsListResponse:v2/AppsListResponse.json"
  "SkillsListParams:v2/SkillsListParams.json"
  "SkillsListResponse:v2/SkillsListResponse.json"
  "SkillsExtraRootsSetParams:v2/SkillsExtraRootsSetParams.json"
  "SkillsExtraRootsSetResponse:v2/SkillsExtraRootsSetResponse.json"
  "SkillsConfigWriteParams:v2/SkillsConfigWriteParams.json"
  "SkillsConfigWriteResponse:v2/SkillsConfigWriteResponse.json"
  "HooksListParams:v2/HooksListParams.json"
  "HooksListResponse:v2/HooksListResponse.json"
  "MarketplaceAddParams:v2/MarketplaceAddParams.json"
  "MarketplaceAddResponse:v2/MarketplaceAddResponse.json"
  "MarketplaceRemoveParams:v2/MarketplaceRemoveParams.json"
  "MarketplaceRemoveResponse:v2/MarketplaceRemoveResponse.json"
  "MarketplaceUpgradeParams:v2/MarketplaceUpgradeParams.json"
  "MarketplaceUpgradeResponse:v2/MarketplaceUpgradeResponse.json"
  "PluginListParams:v2/PluginListParams.json"
  "PluginListResponse:v2/PluginListResponse.json"
  "PluginInstalledParams:v2/PluginInstalledParams.json"
  "PluginInstalledResponse:v2/PluginInstalledResponse.json"
  "PluginReadParams:v2/PluginReadParams.json"
  "PluginReadResponse:v2/PluginReadResponse.json"
  "PluginSkillReadParams:v2/PluginSkillReadParams.json"
  "PluginSkillReadResponse:v2/PluginSkillReadResponse.json"
  "PluginInstallParams:v2/PluginInstallParams.json"
  "PluginInstallResponse:v2/PluginInstallResponse.json"
  "PluginUninstallParams:v2/PluginUninstallParams.json"
  "PluginUninstallResponse:v2/PluginUninstallResponse.json"
  "PluginShareSaveParams:v2/PluginShareSaveParams.json"
  "PluginShareSaveResponse:v2/PluginShareSaveResponse.json"
  "PluginShareUpdateTargetsParams:v2/PluginShareUpdateTargetsParams.json"
  "PluginShareUpdateTargetsResponse:v2/PluginShareUpdateTargetsResponse.json"
  "PluginShareListParams:v2/PluginShareListParams.json"
  "PluginShareListResponse:v2/PluginShareListResponse.json"
  "PluginShareCheckoutParams:v2/PluginShareCheckoutParams.json"
  "PluginShareCheckoutResponse:v2/PluginShareCheckoutResponse.json"
  "PluginShareDeleteParams:v2/PluginShareDeleteParams.json"
  "PluginShareDeleteResponse:v2/PluginShareDeleteResponse.json"
  "FsReadFileParams:v2/FsReadFileParams.json"
  "FsReadFileResponse:v2/FsReadFileResponse.json"
  "FsWriteFileParams:v2/FsWriteFileParams.json"
  "FsWriteFileResponse:v2/FsWriteFileResponse.json"
  "FsCreateDirectoryParams:v2/FsCreateDirectoryParams.json"
  "FsCreateDirectoryResponse:v2/FsCreateDirectoryResponse.json"
  "FsGetMetadataParams:v2/FsGetMetadataParams.json"
  "FsGetMetadataResponse:v2/FsGetMetadataResponse.json"
  "FsReadDirectoryParams:v2/FsReadDirectoryParams.json"
  "FsReadDirectoryResponse:v2/FsReadDirectoryResponse.json"
  "FsRemoveParams:v2/FsRemoveParams.json"
  "FsRemoveResponse:v2/FsRemoveResponse.json"
  "FsCopyParams:v2/FsCopyParams.json"
  "FsCopyResponse:v2/FsCopyResponse.json"
  "FsWatchParams:v2/FsWatchParams.json"
  "FsWatchResponse:v2/FsWatchResponse.json"
  "FsUnwatchParams:v2/FsUnwatchParams.json"
  "FsUnwatchResponse:v2/FsUnwatchResponse.json"
  "ModelListParams:v2/ModelListParams.json"
  "ModelListResponse:v2/ModelListResponse.json"
  "ModelProviderCapabilitiesReadParams:v2/ModelProviderCapabilitiesReadParams.json"
  "ModelProviderCapabilitiesReadResponse:v2/ModelProviderCapabilitiesReadResponse.json"
  "ExperimentalFeatureListParams:v2/ExperimentalFeatureListParams.json"
  "ExperimentalFeatureListResponse:v2/ExperimentalFeatureListResponse.json"
  "ExperimentalFeatureEnablementSetParams:v2/ExperimentalFeatureEnablementSetParams.json"
  "ExperimentalFeatureEnablementSetResponse:v2/ExperimentalFeatureEnablementSetResponse.json"
  "PermissionProfileListParams:v2/PermissionProfileListParams.json"
  "PermissionProfileListResponse:v2/PermissionProfileListResponse.json"
  "McpServerOauthLoginParams:v2/McpServerOauthLoginParams.json"
  "McpServerOauthLoginResponse:v2/McpServerOauthLoginResponse.json"
  "McpServerRefreshResponse:v2/McpServerRefreshResponse.json"
  "ListMcpServerStatusParams:v2/ListMcpServerStatusParams.json"
  "ListMcpServerStatusResponse:v2/ListMcpServerStatusResponse.json"
  "McpResourceReadParams:v2/McpResourceReadParams.json"
  "McpResourceReadResponse:v2/McpResourceReadResponse.json"
  "McpServerToolCallParams:v2/McpServerToolCallParams.json"
  "McpServerToolCallResponse:v2/McpServerToolCallResponse.json"
  ...
  '{
    ...
    gaps: [
      ...
      },
      {
        ...
        status: "tracked_from_rust_source",
        reason: "Upstream exports getConversationSummary, gitDiffToRemote, and getAuthStatus compatibility DTOs from protocol/v1.rs and common.rs, but the pinned schema export does not emit standalone JSON schema files for those deprecated request/response surfaces. The selected local compatibility subset validates these Rust DTO contracts under HXCX-3.74. initialize is covered separately by HXCX-4.11 runtime bootstrap and remains outside the normal app protocol fingerprint."
      }
    ]
  }' > "$ACTUAL"
