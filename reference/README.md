...
- `haxe-rust-performance-convergence-plan.v1.json`: HXCX-7.5 portable/metal convergence plan with benchmark criteria, codexhx profile split, and haxe.rust Bead links.
